    ...
    case c.name do
      ...
      name ->
        cond do
          ...
          Nova.Array.null(c.args) -> c.name
          true -> Nova.Runtime.append(Nova.Runtime.append(c.name, " "), Nova.String.join_with(" ", (Nova.Runtime.map((&show_type_arg/1), c.args))))
        end
    end
  end
