defmodule Nova.Compiler.CodeGen do
  ...
  # @type gen_ctx :: %{module_funcs: set()(string()), locals: set()(string()), func_arities: array()(%{name: string(), arity: int()})}

  def empty_ctx() do
    %{module_funcs: Nova.Set.empty, locals: Nova.Set.empty, func_arities: []}
  end
  ...
  def collect_module_funcs(decls) do
      ...
      go = fn __arg0__ -> fn __arg1__ -> case {__arg0__, __arg1__} do
  ...
  def collect_func_arities(decls) do
      ...
      go = fn __arg0__ -> case __arg0__ do
      ...
      case func.body do
        {:expr_var, ref_name} -> case lookup_arity(ref_name, ctx) do
            {:just, arity} when (arity > 0) -> 
                arg_names = Nova.Runtime.map(fn i -> Nova.Runtime.append("__arg", Nova.Runtime.append(Nova.Runtime.show(i), "__")) end, Nova.Array.range(0, (arity - 1)))
        ...
        _ -> case func.body do
            {:expr_app, ({:expr_qualified, mod_, fn_}), arg} -> if is_partial_app_of_arity2(func.body) do
                  ...
                  {:just, Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(func.name), Nova.Runtime.append("(__arg0__) do\n    ", Nova.Runtime.append(func_name, Nova.Runtime.append("(", Nova.Runtime.append(arg_code, ", __arg0__)\n  end"))))))}
              else
                :nothing
              end
            {:expr_app, ({:expr_var, fn_}), arg} -> if is_partial_app_of_arity2(func.body) do
                  ...
                  arg_code = gen_expr_ctx(ctx, 0, arg)
                  {:just, Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(func.name), Nova.Runtime.append("(__arg0__) do\n    ", Nova.Runtime.append(snake_case(fn_), Nova.Runtime.append("(", Nova.Runtime.append(arg_code, ", __arg0__)\n  end"))))))}
              else
                :nothing
              end
            _ -> :nothing
  ...
  def gen_guarded_function_body(ctx, indent, guards) do
      ...
      is_pat_guard = fn __arg0__ -> case __arg0__ do
        ({:guard_pat, _, _}) -> true
        _ -> false
      end end
  ...
  {:just, %{head: first_guard, tail: rest_guards}} -> 
    ...
    guard_clauses = Nova.Runtime.map(fn __p0__ -> gen_guarded_expr_for_cond(ctx, (indent + 1), __p0__) end, guards)
  ...
  def gen_guard_clauses_simple(ctx, clauses) do
      ...
      extract_expr_guard = fn __arg0__ -> case __arg0__ do
        ({:guard_expr, e}) -> {:just, e}
        _ -> :nothing
      end end
  ...
  if Nova.Array.null(pat_guards) do
    ...
    with_clauses = Nova.Runtime.map(fn __p0__ -> gen_with_clause(ctx, __p0__) end, pat_guards)
  ...
  def gen_guard_clauses(ctx, clauses) do
    if Nova.Array.null(clauses) do
      ...
      Nova.Runtime.intercalate(" and ", Nova.Runtime.map(fn __p0__ -> gen_guard_clause(ctx, __p0__) end, clauses))
    end
  end
  ...
  def collect_args(expr) do
      ...
      go = Nova.Runtime.fix2(fn go -> fn __arg0__ -> fn __arg1__ -> case {__arg0__, __arg1__} do
  ...
  def gen_expr() do
    fn __p0__ -> fn __p1__ -> gen_expr_ctx(empty_ctx(), __p0__, __p1__) end end
  end
  ...
  def is_nullary_constructor(name) do
    Nova.Array.elem(name, ["TokKeyword", "TokIdentifier", "TokNumber", "TokString", "TokChar", "TokOperator", "TokDelimiter", "TokNewline", "TokUnrecognized", "PatWildcard", "ImportAll", "ImportNone"])
  end
  ...
  def gen_partial_app(func_name, applied_args, num_args, arity) do
      ...
      extra_params = Nova.Runtime.map(fn i -> Nova.Runtime.append("__p", Nova.Runtime.append(Nova.Runtime.show(i), "__")) end, Nova.Array.range(0, (remaining - 1)))
  ...
  def gen_constructor_app(ctx, indent, name, args) do
      ...
      gen_args = Nova.Runtime.map(fn __p0__ -> gen_expr_prime(ctx, indent, __p0__) end, args)
  ...
  def gen_expr_prime(ctx, indent, ({:expr_let, binds, body})) do
      ...
      bind_code = Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn __p0__ -> gen_binding_group(ctx, (indent + 1), __p0__) end, sorted_groups))
  ...
  def gen_expr_prime(ctx, indent, ({:expr_case, scrutinee, clauses})) do
      ...
      Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr_prime(ctx, indent, scrutinee), Nova.Runtime.append(" do\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn __p0__ -> gen_case_clause_group(ctx, (indent + 1), __p0__) end, grouped_clauses)), Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), "end"))))))
  end
  ...
  def gen_expr_prime(ctx, _, ({:expr_list, elems})) do
    Nova.Runtime.append("[", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn __p0__ -> gen_expr_prime(ctx, 0, __p0__) end, elems)), "]"))
  end
  ...
  def gen_expr_prime(ctx, _, ({:expr_record_access, rec, field})) do
      ...
      collect_record_access_chain = Nova.Runtime.fix(fn collect_record_access_chain -> fn __arg0__ -> case __arg0__ do
  ...
  {:expr_record_access, inner, inner_field} -> case collect_record_access_chain.(rec) do
  ...
  def gen_expr_prime(_, _, ({:expr_section, op})) do
    case Nova.String.strip_prefix(Nova.String.pattern("."), op) do
      ...
      :nothing -> Nova.Runtime.append("&(", Nova.Runtime.append(gen_bin_op(op), "(&1, &2))"))
    end
  end
  ...
  def contains_var(name, ({:expr_case, scrut, clauses})) do
      ...
      contains_var_in_maybe_expr = fn __arg0__ -> fn __arg1__ -> case {__arg0__, __arg1__} do
        {n, :nothing} -> false
  ...
  def contains_var(name, ({:expr_do, stmts})) do
    Nova.Array.any(fn __p0__ -> contains_var_in_do_stmt(name, __p0__) end, stmts)
  end
  ...
  def contains_var(name, ({:expr_list, es})) do
    Nova.Array.any(fn __p0__ -> contains_var(name, __p0__) end, es)
  end
  ...
  def topo_sort_bind_groups(all_names, infos, resolved) do
    if Nova.Array.null(infos) do
      resolved
        ...
        partitioned = Nova.Array.partition(fn __p0__ -> can_resolve_group(resolved_names, infos, __p0__) end, infos)
  ...
  def can_resolve_group(resolved_names, infos, info) do
    Nova.Array.all(fn __p0__ -> dep_resolved(resolved_names, infos, __p0__) end, info.deps)
  end

  def dep_resolved(resolved_names, infos, d) do
    (Nova.Array.elem(d, resolved_names) or not(Nova.Array.any(fn __p0__ -> has_name(d, __p0__) end, infos)))
  end
  ...
  def get_used_vars(({:expr_do, stmts})) do
      ...
      get_used_vars_stmt = fn __arg0__ -> case __arg0__ do
    ...
    case binds do
      ...
      _ -> case Nova.Array.head(binds) do
          ...
          {:just, first_bind} -> case get_bind_name(first_bind) do
              :nothing -> Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn __p0__ -> gen_let_bind_ctx(ctx, indent, __p0__) end, binds))
              {:just, name} -> 
  ...
  def gen_merged_function(ctx, indent, name, arity, clauses, is_recursive) do
      ...
      scrutinee = if (arity == 1) do
        Nova.Runtime.from_maybe("__arg0__", Nova.Array.head(arg_names))
      else
  ...
  def sort_binds_by_dependencies(binds) do
      ...
      bind_info = Nova.Runtime.map(fn __p0__ -> mk_bind_info(all_names, __p0__) end, binds)
  ...
  def topo_sort_let_binds(infos, resolved) do
    if Nova.Array.null(infos) do
      resolved
        ...
        partitioned = Nova.Array.partition(fn __p0__ -> can_resolve_let_bind(resolved_names, infos, __p0__) end, infos)
        can_resolve = partitioned.yes
        remaining = partitioned.no
        if Nova.Array.null(can_resolve) do
  ...
  def can_resolve_let_bind(resolved_names, infos, info) do
    Nova.Array.all(fn __p0__ -> let_dep_resolved(resolved_names, infos, __p0__) end, info.deps)
  end
  ...
  def is_bind_info_name(name, infos) do
    Nova.Array.any(fn __p0__ -> has_info_name(name, __p0__) end, infos)
  end
  ...
  def gen_let_bind() do
    fn __p0__ -> fn __p1__ -> gen_let_bind_ctx(empty_ctx(), __p0__, __p1__) end end
  end
  ...
  def gen_case_clause() do
    fn __p0__ -> fn __p1__ -> gen_case_clause_ctx(empty_ctx(), __p0__, __p1__) end end
  end
  ...
  def group_guarded_go(cs, acc) do
    case Nova.Array.uncons(cs) do
      ...
      {:just, %{head: c, tail: rest}} -> if (clause_has_guard(c) and not(is_clause_guard_safe(c))) do
            ...
            same_pat = fn __p0__ -> same_clause_pattern(c.pattern, __p0__) end
            spanned = Nova.Array.span(fn __p0__ -> should_group(same_pat, __p0__) end, rest)
  ...
  def gen_with_cond_only(ctx, indent, clauses) do
      ...
      pat = gen_pattern(first_clause.pattern)
      ctx_with_pat = add_locals_from_pattern(first_clause.pattern, ctx)
      Nova.Runtime.append(ind(indent), Nova.Runtime.append(pat, Nova.Runtime.append(" ->\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append("cond do\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn __p0__ -> gen_cond_clause(ctx_with_pat, (indent + 2), __p0__) end, clauses)), Nova.Runtime.append("\n", Nova.Runtime.append(ind((indent + 1)), "end"))))))))
  end
  ...
  def gen_case_clause_ctx(ctx, indent, clause) do
      ...
      add_bind_vars_from_expr = Nova.Runtime.fix2(fn add_bind_vars_from_expr -> fn __arg0__ -> fn __arg1__ -> case {__arg0__, __arg1__} do
  ...
  def gen_do_stmts() do
    fn __p0__ -> fn __p1__ -> gen_do_stmts_ctx(empty_ctx(), __p0__, __p1__) end end
  end
    ...
    case Nova.Array.uncons(stmts) do
      ...
      {:just, %{head: stmt, tail: rest}} -> case stmt do
          {:do_expr, e} -> if Nova.Array.null(rest) do
              ...
              Nova.Runtime.append(gen_expr_prime(ctx, indent, e), Nova.Runtime.append("\n", gen_do_stmts_ctx(ctx, indent, rest)))
            end
          {:do_let, binds} -> 
              ctx_with_binds = Nova.Runtime.foldr(fn b -> fn c -> add_locals_from_pattern(b.pattern, c) end end, ctx, binds)
              Nova.Runtime.append(Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn __p0__ -> gen_let_bind_ctx(ctx, indent, __p0__) end, binds)), Nova.Runtime.append("\n", gen_do_stmts_ctx(ctx_with_binds, indent, rest)))
          {:do_bind, pat, e} -> 
              ctx_with_pat = add_locals_from_pattern(pat, ctx)
              is_maybe_expr = is_maybe_returning(e)
  ...
  def snake_case(s) do
      ...
      go = Nova.Runtime.fix3(fn go -> fn __arg0__ -> fn __arg1__ -> fn __arg2__ -> case {__arg0__, __arg1__, __arg2__} do
        {[], _, acc} -> acc
