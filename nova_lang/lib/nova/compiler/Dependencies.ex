defmodule Nova.Compiler.Dependencies do
  ...
  def get_expr_deps(expr) do
    case expr do
      ...
      {:expr_qualified, ns, name} -> Nova.Set.singleton((Nova.Runtime.append(Nova.Runtime.append(ns, "."), name)))
      ...
      {:expr_section_left, e, _} -> get_expr_deps(e)
      {:expr_section_right, _, e} -> get_expr_deps(e)
    end
  end
  ...
  def remove_from_graph(decl_id, graph) do
      ...
      reverse_prime = Nova.Map.delete(decl_id, (&Nova.Runtime.reverse/1))
