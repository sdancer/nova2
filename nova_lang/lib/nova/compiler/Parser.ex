defmodule Nova.Compiler.Parser do
  ...
  {:just, t} -> if ((t.token_type == :tok_identifier) and (t.value == expected)) do
      ...
      failure(Nova.Runtime.append("Expected identifier '", Nova.Runtime.append(expected, "'")))
    end
  :nothing -> failure(Nova.Runtime.append("Expected identifier '", Nova.Runtime.append(expected, "'")))
end
  end
