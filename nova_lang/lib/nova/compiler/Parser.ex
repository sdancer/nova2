defmodule Nova.Compiler.Parser do
  ...
  :nothing -> failure((Nova.Runtime.append(Nova.Runtime.append("Expected keyword '", expected), "'")))
end
  end
  ...
  :nothing -> failure((Nova.Runtime.append(Nova.Runtime.append("Expected identifier '", expected), "'")))
end
  end
  ...
  :nothing -> failure((Nova.Runtime.append(Nova.Runtime.append("Expected operator '", expected), "'")))
end
  end
  ...
  :nothing -> failure((Nova.Runtime.append(Nova.Runtime.append("Expected delimiter '", expected), "'")))
end
  end
...
case parse_additive_expression(tokens_prime) do
  ...
  {:just, op_tok} ->
    cond do
      (is_operator_token(op_tok) and (op_tok.value != "-")) -> 
  ...
  _ -> case expect_operator(rest_prime, "=") do
      ...
      {:right, ({:tuple, _, rest_prime_prime})} -> case parse_expression(rest_prime_prime) do
          ...
          {:right, ({:tuple, body, rest_prime_prime_prime})} -> 
              lambda = Nova.Compiler.Ast.expr_lambda((Nova.List.from_foldable(params)), body)
