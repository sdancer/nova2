defmodule Nova.Compiler.CodeGen do
  ...
  def free_vars_do(stmts, bound) do
    case Nova.Array.uncons(stmts) do
      :nothing -> Nova.Set.empty
      {:just, %{head: {:do_expr, e}, tail: rest}} -> Nova.Set.union(Nova.Set.difference(free_vars_expr(e), bound), free_vars_do(rest, bound))
  ...
  def collect_func_arities(decls) do
      ...
      go = fn auto_arg0 -> case auto_arg0 do
        ({:decl_function, func}) -> {:just, %{name: func.name, arity: Nova.Runtime.length(func.parameters)}}
        _ -> :nothing
      end end
  ...
  def gen_module(mod_) do
      ...
      ctx = %{empty_ctx() | module_funcs: collect_module_funcs(mod_.declarations), func_arities: collect_func_arities(mod_.declarations)}
      Nova.Runtime.append("defmodule ", Nova.Runtime.append(elixir_module_name(mod_.name), Nova.Runtime.append(" do\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n\n", Nova.Runtime.map(fn auto_p0 -> gen_declaration(ctx, auto_p0) end, mod_.declarations)), "\nend\n"))))
  end
  ...
  def gen_foreign_import(fi) do
      ...
      Nova.Runtime.append("  def ", Nova.Runtime.append(alias_name, Nova.Runtime.append("(arg), do: ", Nova.Runtime.append(ffi_module, Nova.Runtime.append(".", Nova.Runtime.append(func_name, "(arg)"))))))
  end
  ...
  def gen_function(ctx, func) do
    case handle_point_free_alias(ctx, func) do
      ...
      :nothing -> 
          ...
          params = Nova.Runtime.intercalate(", ", Nova.Runtime.map((&gen_pattern/1), func.parameters))
          if Nova.Array.null(func.guards) do
  
    body = gen_expr_ctx(ctx_with_params, 2, func.body)
    Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(func.name), Nova.Runtime.append("(", Nova.Runtime.append(params, Nova.Runtime.append(") do\n", Nova.Runtime.append(body, Nova.Runtime.append("\n", "  end")))))))
else
  
    body_code = gen_guarded_function_body(ctx_with_params, 2, func.guards)
    Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(func.name), Nova.Runtime.append("(", Nova.Runtime.append(params, Nova.Runtime.append(") do\n", Nova.Runtime.append(body_code, Nova.Runtime.append("\n", "  end")))))))
end
    end
  end

  def handle_point_free_alias(ctx, func) do
    if not(Nova.Array.null(func.parameters)) do
      :nothing
    else
      case func.body do
        {:expr_var, ref_name} -> case lookup_arity(ref_name, ctx) do
            {:just, arity} when (arity > 0) -> 
                ...
                {:just, Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(func.name), Nova.Runtime.append("(", Nova.Runtime.append(args_str, Nova.Runtime.append(") do\n    ", Nova.Runtime.append(snake_case(ref_name), Nova.Runtime.append("(", Nova.Runtime.append(args_str, ")\n  end"))))))))}
            _ -> :nothing
          end
        _ -> case func.body do
            {:expr_app, ({:expr_qualified, mod_, fn_}), arg} -> if is_partial_app_of_arity2(func.body) do
                  ...
                  {:just, Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(func.name), Nova.Runtime.append("(auto_arg0) do\n    ", Nova.Runtime.append(func_name, Nova.Runtime.append("(", Nova.Runtime.append(arg_code, ", auto_arg0)\n  end"))))))}
              else
                :nothing
              end
            {:expr_app, ({:expr_var, fn_}), arg} -> if is_partial_app_of_arity2(func.body) do
                  ...
                  arg_code = gen_expr_ctx(ctx, 0, arg)
                  {:just, Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(func.name), Nova.Runtime.append("(auto_arg0) do\n    ", Nova.Runtime.append(snake_case(fn_), Nova.Runtime.append("(", Nova.Runtime.append(arg_code, ", auto_arg0)\n  end"))))))}
              else
                :nothing
              end
            _ -> :nothing
  ...
  {:just, %{head: first_guard, tail: rest_guards}} -> 
      pat_guards = Nova.Array.filter(is_pat_guard, first_guard.guards)
      expr_guards = Nova.Array.filter(fn g -> not(is_pat_guard.(g)) end, first_guard.guards)
    ...
    Nova.Runtime.append(ind(indent), Nova.Runtime.append("cond do\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n", guard_clauses), Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), "end")))))
else
  ...
  [{:guard_pat, pat, scrutinee_expr}] -> 
      ...
      Nova.Runtime.append(ind(indent), Nova.Runtime.append("case ", Nova.Runtime.append(scrutinee, Nova.Runtime.append(" do\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append(pat_str, Nova.Runtime.append(when_clause, Nova.Runtime.append(" ->\n", Nova.Runtime.append(ind((indent + 2)), Nova.Runtime.append(body_expr, Nova.Runtime.append("\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append("_ ->\n", Nova.Runtime.append(fallthrough, Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), "end"))))))))))))))))
    ...
    case Nova.Array.uncons(pat_guards) do
      :nothing -> if Nova.Array.null(expr_guards) do
          gen_expr_ctx(ctx, indent, body)
            ...
            Nova.Runtime.append(ind(indent), Nova.Runtime.append("if ", Nova.Runtime.append(gen_guard_clauses_simple(ctx, expr_guards), Nova.Runtime.append(" do\n", Nova.Runtime.append(gen_expr_ctx(ctx, (indent + 1), body), Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), Nova.Runtime.append("else\n", Nova.Runtime.append(fallthrough, Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), "end")))))))))))
        end
      {:just, %{head: {:guard_pat, pat, scrutinee_expr}, tail: remaining_pat_guards}} -> 
          ...
          Nova.Runtime.append(ind(indent), Nova.Runtime.append("case ", Nova.Runtime.append(scrutinee, Nova.Runtime.append(" do\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append(pat_str, Nova.Runtime.append(" ->\n", Nova.Runtime.append(inner_code, Nova.Runtime.append("\n", Nova.Runtime.append(fallthrough, Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), "end"))))))))))))
  ...
  def gen_guarded_expr_for_cond(ctx, indent, ge) do
      ...
      expr_guards = ge.guards
      body_expr = gen_expr_ctx(ctx, 0, ge.body)
      guard_expr = gen_guard_clauses(ctx, expr_guards)
      Nova.Runtime.append(ind(indent), Nova.Runtime.append(guard_expr, Nova.Runtime.append(" ->\n", Nova.Runtime.append(ind((indent + 1)), body_expr))))
  end
  ...
  pat_guards = Nova.Array.filter(is_pat_guard, ge.guards)
  expr_guards = Nova.Array.filter(fn g -> not(is_pat_guard.(g)) end, ge.guards)
  body_expr = gen_expr_ctx(ctx, 0, ge.body)
  indent_str = repeat_str(indent, " ")
  if Nova.Array.null(pat_guards) do
  
    guard_expr = gen_guard_clauses(ctx, expr_guards)
    Nova.Runtime.append(indent_str, Nova.Runtime.append(guard_expr, Nova.Runtime.append(" ->\n", Nova.Runtime.append(indent_str, Nova.Runtime.append("  ", body_expr)))))
else
    ...
    expr_guard_code = if Nova.Array.null(expr_guards) do
      ...
      Nova.Runtime.append(",\n", Nova.Runtime.append(indent_str, Nova.Runtime.append("       true <- (", Nova.Runtime.append(gen_guard_clauses(ctx, expr_guards), ")"))))
    end
    Nova.Runtime.append(indent_str, Nova.Runtime.append("true ->\n", Nova.Runtime.append(indent_str, Nova.Runtime.append("  with ", Nova.Runtime.append(Nova.Runtime.intercalate(Nova.Runtime.append(",\n", Nova.Runtime.append(indent_str, "       ")), with_clauses), Nova.Runtime.append(expr_guard_code, Nova.Runtime.append(" do\n", Nova.Runtime.append(indent_str, Nova.Runtime.append("    ", Nova.Runtime.append(body_expr, Nova.Runtime.append("\n", Nova.Runtime.append(indent_str, Nova.Runtime.append("  else\n", Nova.Runtime.append(indent_str, Nova.Runtime.append("    _ -> :__guard_failed__\n", Nova.Runtime.append(indent_str, "  end"))))))))))))))))
end
  end

  def gen_with_clause(ctx, ({:guard_pat, pat, expr})) do
    Nova.Runtime.append(gen_pattern(pat), Nova.Runtime.append(" <- ", gen_expr_ctx(ctx, 0, expr)))
  end

  def gen_with_clause(ctx, ({:guard_expr, expr})) do
    Nova.Runtime.append("true <- (", Nova.Runtime.append(gen_expr_ctx(ctx, 0, expr), ")"))
  end
  ...
  def gen_guard_clause(ctx, ({:guard_pat, pat, expr})) do
    Nova.Runtime.append("match?(", Nova.Runtime.append(gen_pattern(pat), Nova.Runtime.append(", ", Nova.Runtime.append(gen_expr_ctx(ctx, 0, expr), ")"))))
  end
  ...
  def gen_pattern(({:pat_con, name, pats})) do
      ...
      if Nova.Array.null(pats) do
  Nova.Runtime.append(":", snake_case(con_name))
else
  Nova.Runtime.append("{:", Nova.Runtime.append(snake_case(con_name), Nova.Runtime.append(", ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map((&gen_pattern/1), pats)), "}"))))
end
  end

  def gen_pattern(({:pat_record, fields})) do
    
      gen_field_pattern = fn ({:tuple, label, pat}) -> Nova.Runtime.append(snake_case(label), Nova.Runtime.append(": ", gen_pattern(pat))) end
      Nova.Runtime.append("%{", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(gen_field_pattern, fields)), "}"))
  end

  def gen_pattern(({:pat_list, pats})) do
    Nova.Runtime.append("[", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map((&gen_pattern/1), pats)), "]"))
  end

  def gen_pattern(({:pat_cons, head, tail})) do
    Nova.Runtime.append("[", Nova.Runtime.append(gen_pattern(head), Nova.Runtime.append(" | ", Nova.Runtime.append(gen_pattern(tail), "]"))))
  end

  def gen_pattern(({:pat_as, name, pat})) do
    Nova.Runtime.append(gen_pattern(pat), Nova.Runtime.append(" = ", snake_case(name)))
  end
  ...
  Nova.Runtime.append("{:", Nova.Runtime.append(snake_case(con_name), Nova.Runtime.append(", ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_pattern_with_used(used, auto_p0) end, pats)), "}"))))
end
  end

  def gen_pattern_with_used(used, ({:pat_record, fields})) do
    
      gen_field_pattern = fn ({:tuple, label, pat}) -> Nova.Runtime.append(snake_case(label), Nova.Runtime.append(": ", gen_pattern_with_used(used, pat))) end
      Nova.Runtime.append("%{", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(gen_field_pattern, fields)), "}"))
  end

  def gen_pattern_with_used(used, ({:pat_list, pats})) do
    Nova.Runtime.append("[", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_pattern_with_used(used, auto_p0) end, pats)), "]"))
  end

  def gen_pattern_with_used(used, ({:pat_cons, head, tail})) do
    Nova.Runtime.append("[", Nova.Runtime.append(gen_pattern_with_used(used, head), Nova.Runtime.append(" | ", Nova.Runtime.append(gen_pattern_with_used(used, tail), "]"))))
  end
  ...
  def gen_pattern_with_used(used, ({:pat_as, name, pat})) do
      ...
      Nova.Runtime.append(gen_pattern_with_used(used, pat), Nova.Runtime.append(" = ", Nova.Runtime.append(prefix, snake_case(name))))
  end
  ...
  def gen_chained_app(func_name, args, ctx, indent) do
    case Nova.Array.uncons(args) do
      ...
      {:just, %{head: first_arg, tail: rest_args}} -> 
          first_app = Nova.Runtime.append(func_name, Nova.Runtime.append(".(", Nova.Runtime.append(gen_expr_prime(ctx, indent, first_arg), ")")))
          Nova.Runtime.foldl(fn acc -> fn arg -> Nova.Runtime.append(acc, Nova.Runtime.append(".(", Nova.Runtime.append(gen_expr_prime(ctx, indent, arg), ")"))) end end, first_app, rest_args)
    end
  end
  ...
  def translate_qualified(mod_, name) do
    case {:tuple, mod_, name} do
      ...
      _ -> 
          ...
          Nova.Runtime.append(elixir_mod, Nova.Runtime.append(".", snake_case(name)))
    end
  end
  ...
  def gen_partial_app(func_name, applied_args, num_args, arity) do
      ...
      curried_header = Nova.Runtime.intercalate(" ", Nova.Runtime.map(fn p -> Nova.Runtime.append("fn ", Nova.Runtime.append(p, " ->")) end, extra_params))
      ...
      all_args_str = if (num_args == 0) do
        ...
        Nova.Runtime.append(applied_args, Nova.Runtime.append(", ", Nova.Runtime.intercalate(", ", extra_params)))
      end
      Nova.Runtime.append(curried_header, Nova.Runtime.append(" ", Nova.Runtime.append(func_name, Nova.Runtime.append("(", Nova.Runtime.append(all_args_str, Nova.Runtime.append(")", curried_ends))))))
  end
  ...
  def gen_constructor_app(ctx, indent, name, args) do
      ...
      default_gen = if is_ast_constructor(name) do
        Nova.Runtime.append(ast_prefix, Nova.Runtime.append(snake_case(name), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), ")"))))
      else
        Nova.Runtime.append("{:", Nova.Runtime.append(snake_case(name), Nova.Runtime.append(", ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))))
      end
      default_gen_no_args = if is_ast_constructor(name) do
        Nova.Runtime.append(ast_prefix, Nova.Runtime.append(snake_case(name), "()"))
      else
        Nova.Runtime.append(":", snake_case(name))
      end
      case name do
  "Tuple" -> case gen_args do
      [a, b] -> Nova.Runtime.append("{:tuple, ", Nova.Runtime.append(a, Nova.Runtime.append(", ", Nova.Runtime.append(b, "}"))))
      _ -> Nova.Runtime.append("{:tuple, ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))
    end
  "Tuple2" -> Nova.Runtime.append("{:tuple, ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))
  "Tuple3" -> Nova.Runtime.append("{:tuple3, ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))
  "Tuple4" -> Nova.Runtime.append("{:tuple4, ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))
  "Tuple5" -> Nova.Runtime.append("{:tuple5, ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))
  "Just" -> Nova.Runtime.append("{:just, ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))
  "Nothing" -> ":nothing"
  "Left" -> Nova.Runtime.append("{:left, ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))
  "Right" -> Nova.Runtime.append("{:right, ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), "}"))
  "Cons" -> case gen_args do
      [h, t] -> Nova.Runtime.append("[", Nova.Runtime.append(h, Nova.Runtime.append(" | ", Nova.Runtime.append(t, "]"))))
      _ -> Nova.Runtime.append("Nova.Runtime.cons(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", gen_args), ")"))
    end
  "Nil" -> "[]"
            ...
            if is_nullary_constructor(name) do
              ...
              if is_module_func(ctx, name) do
                case lookup_arity(name, ctx) do
                  ...
                  {:just, arity} -> Nova.Runtime.append("(&", Nova.Runtime.append(snake_case(name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(arity), ")"))))
                ...
                if is_types_module_func(name) do
                    ...
                    if (arity == 0) do
  Nova.Runtime.append("Nova.Compiler.Types.", Nova.Runtime.append(snake_case(name), "()"))
else
  Nova.Runtime.append("(&Nova.Compiler.Types.", Nova.Runtime.append(snake_case(name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(arity), ")"))))
end
                else
                  if is_unify_module_func(name) do
                    Nova.Runtime.append("(&Nova.Compiler.Unify.", Nova.Runtime.append(snake_case(name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(unify_module_func_arity(name)), ")"))))
                  else
                    if is_prelude_func(name) do
                      Nova.Runtime.append("(&Nova.Runtime.", Nova.Runtime.append(snake_case(name), "/1)"))
                    else
                      if is_ast_constructor(name) do
                        Nova.Runtime.append("(&Nova.Compiler.Ast.", Nova.Runtime.append(snake_case(name), "/1)"))
                      else
  ...
  if (arity == 1) do
    Nova.Runtime.append("fn a -> ", Nova.Runtime.append(translate_qualified(mod_, name), "(a) end"))
  else
    Nova.Runtime.append("fn a, b -> ", Nova.Runtime.append(translate_qualified(mod_, name), "(a, b) end"))
  end
end
    else
      if is_types_module_func(name) do
  ...
  def gen_expr_prime(ctx, indent, ({:expr_app, f, arg})) do
      ...
      gen_var_app = fn c -> fn i -> fn n -> fn as -> fn args_s -> if (n == "not") do
        Nova.Runtime.append("not(", Nova.Runtime.append(args_s, ")"))
      else
        if (n == "mod") do
          Nova.Runtime.append("rem(", Nova.Runtime.append(args_s, ")"))
        else
    ...
    Nova.Runtime.append(translate_qualified(Nova.Runtime.intercalate(".", mod_parts), func_name), Nova.Runtime.append("(", Nova.Runtime.append(args_s, ")")))
else
  Nova.Runtime.append(snake_case(n), Nova.Runtime.append(".(", Nova.Runtime.append(args_s, ")")))
end
          else
            if is_data_constructor(n) do
              gen_constructor_app(c, i, n, as)
            else
              if is_module_func(c, n) do
                case lookup_arity(n, c) do
                  {:just, arity} -> 
                      num_args = Nova.Runtime.length(as)
  ...
  if (num_args < arity) do
    ...
    Nova.Runtime.append(snake_case(n), Nova.Runtime.append("(", Nova.Runtime.append(args_s, ")")))
                  ...
                  :nothing -> Nova.Runtime.append(snake_case(n), Nova.Runtime.append("(", Nova.Runtime.append(args_s, ")")))
                end
              else
                if is_types_module_func(n) do
                    ...
                    num_args = Nova.Runtime.length(as)
                    if (num_args == arity) do
  Nova.Runtime.append("Nova.Compiler.Types.", Nova.Runtime.append(snake_case(n), Nova.Runtime.append("(", Nova.Runtime.append(args_s, ")"))))
else
  if (num_args < arity) do
    ...
    Nova.Runtime.append("Nova.Compiler.Types.", Nova.Runtime.append(snake_case(n), Nova.Runtime.append("(", Nova.Runtime.append(args_s, ")"))))
                  ...
                  if is_unify_module_func(n) do
                      ...
                      num_args = Nova.Runtime.length(as)
                      if (num_args == arity) do
  Nova.Runtime.append("Nova.Compiler.Unify.", Nova.Runtime.append(snake_case(n), Nova.Runtime.append("(", Nova.Runtime.append(args_s, ")"))))
else
  if (num_args < arity) do
    ...
    Nova.Runtime.append("Nova.Compiler.Unify.", Nova.Runtime.append(snake_case(n), Nova.Runtime.append("(", Nova.Runtime.append(args_s, ")"))))
                    ...
                    if is_prelude_func(n) do
                      Nova.Runtime.append("Nova.Runtime.", Nova.Runtime.append(snake_case(n), Nova.Runtime.append("(", Nova.Runtime.append(args_s, ")"))))
                    else
                      gen_chained_app(snake_case(n), as, c, i)
                    end
                  end
                end
              end
  ...
  {:expr_qualified, m, n} -> Nova.Runtime.append(translate_qualified(m, n), Nova.Runtime.append("(", Nova.Runtime.append(args_str, ")")))
  {:expr_lambda, _, _} -> Nova.Runtime.append("(", Nova.Runtime.append(gen_expr_prime(ctx, indent, func), Nova.Runtime.append(").(", Nova.Runtime.append(args_str, ")"))))
  _ -> Nova.Runtime.append("(", Nova.Runtime.append(gen_expr_prime(ctx, indent, func), Nova.Runtime.append(").(", Nova.Runtime.append(args_str, ")"))))
end
  end

  def gen_expr_prime(ctx, indent, ({:expr_lambda, pats, body})) do
    
      gen_curried_lambda = Nova.Runtime.fix4(fn gen_curried_lambda -> fn c -> fn i -> fn ps -> fn b -> case Nova.Array.uncons(ps) do
        :nothing -> gen_expr_prime(c, i, b)
        {:just, %{head: p, tail: rest}} -> if Nova.Array.null(rest) do
            Nova.Runtime.append("fn ", Nova.Runtime.append(gen_pattern(p), Nova.Runtime.append(" -> ", Nova.Runtime.append(gen_expr_prime(c, i, b), " end"))))
          else
            Nova.Runtime.append("fn ", Nova.Runtime.append(gen_pattern(p), Nova.Runtime.append(" -> ", Nova.Runtime.append(gen_curried_lambda.(c).(i).(rest).(b), " end"))))
          end
      end  end end end end end)
  ...
  def gen_expr_prime(ctx, indent, ({:expr_let, binds, body})) do
      ...
      grouped_binds = group_binds_by_name(binds)
      ...
      Nova.Runtime.append("\n", Nova.Runtime.append(bind_code, Nova.Runtime.append("\n", Nova.Runtime.append(ind((indent + 1)), gen_expr_prime(ctx_with_binds, 0, body)))))
  end

  def gen_expr_prime(ctx, indent, ({:expr_if, cond_, then_, else_})) do
    Nova.Runtime.append("if ", Nova.Runtime.append(gen_expr_prime(ctx, indent, cond_), Nova.Runtime.append(" do\n", Nova.Runtime.append(gen_expr_ctx(ctx, (indent + 1), then_), Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), Nova.Runtime.append("else\n", Nova.Runtime.append(gen_expr_ctx(ctx, (indent + 1), else_), Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), "end"))))))))))
  end

  def gen_expr_prime(ctx, indent, ({:expr_case, scrutinee, clauses})) do
    
      grouped_clauses = group_wildcard_guarded_clauses(clauses)
      Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr_prime(ctx, indent, scrutinee), Nova.Runtime.append(" do\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn auto_p0 -> gen_case_clause_group(ctx, (indent + 1), auto_p0) end, grouped_clauses)), Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), "end"))))))
  end

  def gen_expr_prime(ctx, indent, ({:expr_do, stmts})) do
    gen_do_stmts_ctx(ctx, indent, stmts)
  end

  def gen_expr_prime(ctx, _, ({:expr_bin_op, ":", l, r})) do
    Nova.Runtime.append("[", Nova.Runtime.append(gen_expr_prime(ctx, 0, l), Nova.Runtime.append(" | ", Nova.Runtime.append(gen_expr_prime(ctx, 0, r), "]"))))
  end
  ...
  def gen_expr_prime(ctx, _, ({:expr_bin_op, op, l, r})) do
      ...
      if (Nova.String.contains(Nova.String.pattern("."), op) or is_upper_case.(Nova.String.take(1, op))) do
  ...
  snake_case(op)
    ...
    Nova.Runtime.append(func_call, Nova.Runtime.append("(", Nova.Runtime.append(gen_expr_prime(ctx, 0, l), Nova.Runtime.append(", ", Nova.Runtime.append(gen_expr_prime(ctx, 0, r), ")")))))
else
  Nova.Runtime.append("(", Nova.Runtime.append(gen_expr_prime(ctx, 0, l), Nova.Runtime.append(" ", Nova.Runtime.append(gen_bin_op(op), Nova.Runtime.append(" ", Nova.Runtime.append(gen_expr_prime(ctx, 0, r), ")"))))))
end
  end
  ...
  def gen_expr_prime(ctx, _, ({:expr_list, elems})) do
    Nova.Runtime.append("[", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr_prime(ctx, 0, auto_p0) end, elems)), "]"))
  end
  ...
  def gen_expr_prime(ctx, _, ({:expr_record, fields})) do
      ...
      gen_record_field = fn ({:tuple, label, expr}) -> Nova.Runtime.append(snake_case(label), Nova.Runtime.append(": ", gen_expr_prime(ctx, 0, expr))) end
      Nova.Runtime.append("%{", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(gen_record_field, fields)), "}"))
  end
  ...
  {:expr_record_access, _inner, _inner_field} -> case collect_record_access_chain.(rec) do
      %{base: {:expr_var, "_"}, fields: fields} -> Nova.Runtime.append("& &1.", Nova.Runtime.append(Nova.Runtime.intercalate(".", Nova.Runtime.map((&snake_case/1), fields)), Nova.Runtime.append(".", snake_case(field))))
      _ -> Nova.Runtime.append(gen_expr_prime(ctx, 0, rec), Nova.Runtime.append(".", snake_case(field)))
    end
  _ -> Nova.Runtime.append(gen_expr_prime(ctx, 0, rec), Nova.Runtime.append(".", snake_case(field)))
end
  end
  ...
  def gen_expr_prime(ctx, _, ({:expr_record_update, rec, fields})) do
      ...
      gen_update_field = fn ({:tuple, label, expr}) -> Nova.Runtime.append(snake_case(label), Nova.Runtime.append(": ", gen_expr_prime(ctx, 0, expr))) end
      Nova.Runtime.append("%{", Nova.Runtime.append(gen_expr_prime(ctx, 0, rec), Nova.Runtime.append(" | ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(gen_update_field, fields)), "}"))))
  end
  ...
  def gen_expr_prime(_, _, ({:expr_section, op})) do
    case Nova.String.strip_prefix(Nova.String.pattern("."), op) do
      ...
      :nothing -> Nova.Runtime.append("fn __x__, __y__ -> (__x__ ", Nova.Runtime.append(gen_bin_op(op), " __y__) end"))
    end
  end

  def gen_expr_prime(ctx, _, ({:expr_section_left, expr, op})) do
    Nova.Runtime.append("fn __x__ -> (", Nova.Runtime.append(gen_expr_prime(ctx, 0, expr), Nova.Runtime.append(" ", Nova.Runtime.append(gen_bin_op(op), " __x__) end"))))
  end

  def gen_expr_prime(ctx, _, ({:expr_section_right, op, expr})) do
    Nova.Runtime.append("fn __x__ -> (__x__ ", Nova.Runtime.append(gen_bin_op(op), Nova.Runtime.append(" ", Nova.Runtime.append(gen_expr_prime(ctx, 0, expr), ") end"))))
  end
  ...
  def contains_var(name, ({:expr_let, binds, body})) do
    (Nova.Array.any(fn b -> contains_var(name, b.value) end, binds) or contains_var(name, body))
  end
  ...
  def contains_var(name, ({:expr_case, scrut, clauses})) do
      ...
      (contains_var(name, scrut) or Nova.Array.any(fn cl -> (contains_var(name, cl.body) or contains_var_in_maybe_expr.(name).(cl.guard)) end, clauses))
  end

  def contains_var(name, ({:expr_do, stmts})) do
    Nova.Array.any(fn auto_p0 -> contains_var_in_do_stmt(name, auto_p0) end, stmts)
  end
  ...
  def contains_var(name, ({:expr_list, es})) do
    Nova.Array.any(fn auto_p0 -> contains_var(name, auto_p0) end, es)
  end
  ...
  def contains_var(name, ({:expr_record, fs})) do
    Nova.Array.any(fn ({:tuple, _, e}) -> contains_var(name, e) end, fs)
  end
  ...
  def contains_var(name, ({:expr_record_update, e, fs})) do
    (contains_var(name, e) or Nova.Array.any(fn ({:tuple, _, ex}) -> contains_var(name, ex) end, fs))
  end
  ...
  def contains_var_in_do_stmt(name, ({:do_let, binds})) do
    Nova.Array.any(fn b -> contains_var(name, b.value) end, binds)
  end
  ...
  def get_used_vars(({:expr_let, binds, body})) do
    Nova.Runtime.append(Nova.Array.concat_map(fn b -> get_used_vars(b.value) end, binds), get_used_vars(body))
  end

  def get_used_vars(({:expr_if, c, t, e})) do
    Nova.Runtime.append(get_used_vars(c), Nova.Runtime.append(get_used_vars(t), get_used_vars(e)))
  end

  def get_used_vars(({:expr_case, scrut, clauses})) do
    Nova.Runtime.append(get_used_vars(scrut), Nova.Array.concat_map(fn cl -> get_used_vars(cl.body) end, clauses))
  end
  ...
  def get_used_vars(({:expr_list, elems})) do
    Nova.Array.concat_map((&get_used_vars/1), elems)
  end

  def get_used_vars(({:expr_record, fields})) do
    Nova.Array.concat_map(fn ({:tuple, _, v}) -> get_used_vars(v) end, fields)
  end
  ...
  def get_used_vars(({:expr_record_update, rec, fields})) do
    Nova.Runtime.append(get_used_vars(rec), Nova.Array.concat_map(fn ({:tuple, _, v}) -> get_used_vars(v) end, fields))
  end

  def get_used_vars(({:expr_do, stmts})) do
    
      get_used_vars_stmt = fn auto_arg0 -> case auto_arg0 do
        ({:do_let, binds}) -> Nova.Array.concat_map(fn b -> get_used_vars(b.value) end, binds)
        ({:do_bind, _, e}) -> get_used_vars(e)
        ({:do_expr, e}) -> get_used_vars(e)
      end end
      Nova.Array.concat_map(get_used_vars_stmt, stmts)
  end
  ...
  def extract_lambda_clause(bind) do
    case bind.value do
      {:expr_lambda, pats, body} -> {:just, %{patterns: pats, body: body}}
      _ -> :nothing
    end
  end
  ...
  def gen_merged_function(ctx, indent, name, arity, clauses, is_recursive) do
      ...
      args_str = Nova.Runtime.intercalate(", ", arg_names)
      curried_lambda_header = Nova.Runtime.intercalate(" ", Nova.Runtime.map(fn a -> Nova.Runtime.append("fn ", Nova.Runtime.append(a, " ->")) end, arg_names))
      ...
      if is_recursive do
  Nova.Runtime.append(ind(indent), Nova.Runtime.append(snake_case(name), Nova.Runtime.append(" = ", Nova.Runtime.append(fix_fn, Nova.Runtime.append("(fn ", Nova.Runtime.append(snake_case(name), Nova.Runtime.append(" -> ", Nova.Runtime.append(curried_lambda_header, Nova.Runtime.append(" case ", Nova.Runtime.append(scrutinee, Nova.Runtime.append(" do\n", Nova.Runtime.append(case_body, Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), Nova.Runtime.append("end", Nova.Runtime.append(curried_lambda_ends, " end)"))))))))))))))))
else
  Nova.Runtime.append(ind(indent), Nova.Runtime.append(snake_case(name), Nova.Runtime.append(" = ", Nova.Runtime.append(curried_lambda_header, Nova.Runtime.append(" case ", Nova.Runtime.append(scrutinee, Nova.Runtime.append(" do\n", Nova.Runtime.append(case_body, Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), Nova.Runtime.append("end", curried_lambda_ends)))))))))))
end
  end
  ...
  def gen_merged_case_clauses(ctx, indent, arity, clauses) do
      ...
      gen_clause = fn clause -> 
        ...
        Nova.Runtime.append(ind(indent), Nova.Runtime.append(pat_str, Nova.Runtime.append(" -> ", body_str))) end
  ...
  %{is_recursive: true, var_name: {:just, name}, value: {:expr_lambda, pats, body}} -> 
      ...
      ctx_with_params = Nova.Runtime.foldr((&add_locals_from_pattern/2), ctx, pats)
      curried_lambda_header = Nova.Runtime.intercalate(" ", Nova.Runtime.map(fn p -> Nova.Runtime.append("fn ", Nova.Runtime.append(gen_pattern(p), " ->")) end, pats))
      curried_lambda_ends = Nova.Runtime.intercalate("", Nova.Runtime.map(fn _ -> " end" end, pats))
      body_code = gen_expr_prime(ctx_with_params, indent, body)
      Nova.Runtime.append(ind(indent), Nova.Runtime.append(snake_case(name), Nova.Runtime.append(" = ", Nova.Runtime.append(fix_fn, Nova.Runtime.append("(fn ", Nova.Runtime.append(snake_case(name), Nova.Runtime.append(" -> ", Nova.Runtime.append(curried_lambda_header, Nova.Runtime.append(" ", Nova.Runtime.append(body_code, Nova.Runtime.append(" ", Nova.Runtime.append(curried_lambda_ends, " end)"))))))))))))
  _ -> Nova.Runtime.append(ind(indent), Nova.Runtime.append(gen_pattern(bind.pattern), Nova.Runtime.append(" = ", gen_expr_prime(ctx, indent, bind.value))))
end
  end
  ...
  def expr_to_pattern(({:expr_app, ({:expr_var, "Just"}), arg})) do
    Nova.Runtime.append("{:just, ", Nova.Runtime.append(expr_to_pattern(arg), "}"))
  end
  ...
  def expr_to_pattern(({:expr_app, ({:expr_var, "Right"}), arg})) do
    Nova.Runtime.append("{:right, ", Nova.Runtime.append(expr_to_pattern(arg), "}"))
  end

  def expr_to_pattern(({:expr_app, ({:expr_var, "Left"}), arg})) do
    Nova.Runtime.append("{:left, ", Nova.Runtime.append(expr_to_pattern(arg), "}"))
  end

  def expr_to_pattern(({:expr_app, ({:expr_app, ({:expr_var, "Tuple"}), a}), b})) do
    Nova.Runtime.append("{:tuple, ", Nova.Runtime.append(expr_to_pattern(a), Nova.Runtime.append(", ", Nova.Runtime.append(expr_to_pattern(b), "}"))))
  end

  def expr_to_pattern(({:expr_app, f, arg})) do
    case f do
      {:expr_var, con} -> Nova.Runtime.append("{:", Nova.Runtime.append(snake_case(con), Nova.Runtime.append(", ", Nova.Runtime.append(expr_to_pattern(arg), "}"))))
      {:expr_app, _, _} -> 
          %{func: func, args: args} = collect_args(Nova.Compiler.Ast.expr_app(f, arg))
          case func do
  {:expr_var, con} -> Nova.Runtime.append("{:", Nova.Runtime.append(snake_case(con), Nova.Runtime.append(", ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map((&expr_to_pattern/1), args)), "}"))))
  _ -> "_"
end
      _ -> "_"
    end
  ...
  def expr_to_pattern(({:expr_record, fields})) do
      ...
      gen_record_fields = fn fs -> Nova.Runtime.append("{", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn ({:tuple, k, v}) -> Nova.Runtime.append(snake_case(k), Nova.Runtime.append(": ", expr_to_pattern(v))) end, fs)), "}")) end
  ...
  def gen_with_wildcard_fallback(ctx, indent, clauses) do
      ...
      Nova.Runtime.append(ind(indent), Nova.Runtime.append(pat, Nova.Runtime.append(" ->\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append("cond do\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn auto_p0 -> gen_cond_clause(ctx_with_pat, (indent + 2), auto_p0) end, init_clauses)), Nova.Runtime.append("\n", Nova.Runtime.append(ind((indent + 2)), Nova.Runtime.append("true -> ", Nova.Runtime.append(fallback_body, Nova.Runtime.append("\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append("end\n", Nova.Runtime.append(ind(indent), Nova.Runtime.append("_ -> ", fallback_body)))))))))))))))
  end
  ...
  def gen_with_cond_only(ctx, indent, clauses) do
      ...
      pat = gen_pattern_with_used(used_vars, first_clause.pattern)
      ctx_with_pat = add_locals_from_pattern(first_clause.pattern, ctx)
      Nova.Runtime.append(ind(indent), Nova.Runtime.append(pat, Nova.Runtime.append(" ->\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append("cond do\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn auto_p0 -> gen_cond_clause(ctx_with_pat, (indent + 2), auto_p0) end, clauses)), Nova.Runtime.append("\n", Nova.Runtime.append(ind((indent + 1)), "end"))))))))
  end
  ...
  def gen_cond_clause(ctx, indent, clause) do
      ...
      case clause.guard do
  {:just, g} -> Nova.Runtime.append(ind(indent), Nova.Runtime.append(gen_expr_prime(ctx, 0, g), Nova.Runtime.append(" -> ", body)))
  :nothing -> Nova.Runtime.append(ind(indent), Nova.Runtime.append("true -> ", body))
end
  end
  ...
  case clause.guard do
  :nothing -> Nova.Runtime.append(ind(indent), Nova.Runtime.append(pat, Nova.Runtime.append(" -> ", body)))
  {:just, g} -> if contains_pattern_bind(g) do
      ...
      if is_guard_safe(g) do
        Nova.Runtime.append(ind(indent), Nova.Runtime.append(pat, Nova.Runtime.append(" when ", Nova.Runtime.append(gen_expr_prime(ctx_with_pat, indent, g), Nova.Runtime.append(" -> ", body)))))
      else
        Nova.Runtime.append(ind(indent), Nova.Runtime.append(pat, Nova.Runtime.append(" ->\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append("if ", Nova.Runtime.append(gen_expr_prime(ctx_with_pat, indent, g), Nova.Runtime.append(" do\n", Nova.Runtime.append(ind((indent + 2)), Nova.Runtime.append(body, Nova.Runtime.append("\n", Nova.Runtime.append(ind((indent + 1)), "end")))))))))))
      end
    end
end
  end
  ...
  :nothing -> if Nova.Array.null(conds) do
      body
        ...
        Nova.Runtime.append(ind(indent), Nova.Runtime.append("if ", Nova.Runtime.append(gen_expr_prime(ctx, indent, cond_expr), Nova.Runtime.append(" do\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append(body, Nova.Runtime.append("\n", Nova.Runtime.append(ind(indent), "end"))))))))
    end
  {:just, %{head: pb, tail: rest_binds}} -> 
      ...
      Nova.Runtime.append(ind(indent), Nova.Runtime.append("case ", Nova.Runtime.append(expr_str, Nova.Runtime.append(" do\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append(pat_str, Nova.Runtime.append(" -> ", Nova.Runtime.append(inner_code, Nova.Runtime.append("\n", Nova.Runtime.append(ind((indent + 1)), Nova.Runtime.append("_ -> nil\n", Nova.Runtime.append(ind(indent), "end"))))))))))))
end
  end
  ...
  Nova.Runtime.append(ind_str, Nova.Runtime.append(gen_expr_prime(ctx, 0, e), Nova.Runtime.append("\n", gen_do_stmts_ctx(ctx, indent, rest))))
end
          {:do_let, binds} -> 
              ctx_with_binds = Nova.Runtime.foldr(fn b -> fn c -> add_locals_from_pattern(b.pattern, c) end end, ctx, binds)
              Nova.Runtime.append(Nova.Runtime.intercalate("\n", Nova.Runtime.map(fn auto_p0 -> gen_let_bind_ctx(ctx, indent, auto_p0) end, binds)), Nova.Runtime.append("\n", gen_do_stmts_ctx(ctx_with_binds, indent, rest)))
          {:do_bind, pat, e} -> 
              ctx_with_pat = add_locals_from_pattern(pat, ctx)
              monad_type = detect_monad_type(e)
              ind_str = repeat_str(indent, " ")
              pat_str = case pat do
                {:pat_con, "Tuple", [p1, p2]} -> Nova.Runtime.append("{:tuple, ", Nova.Runtime.append(gen_pattern(p1), Nova.Runtime.append(", ", Nova.Runtime.append(gen_pattern(p2), "}"))))
                _ -> gen_pattern(pat)
              end
              if (monad_type == 0) do
  Nova.Runtime.append(ind_str, Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr_prime(ctx, 0, e), Nova.Runtime.append(" do\n", Nova.Runtime.append(ind_str, Nova.Runtime.append("  :nothing -> :nothing\n", Nova.Runtime.append(ind_str, Nova.Runtime.append("  {:just, ", Nova.Runtime.append(pat_str, Nova.Runtime.append("} ->\n", Nova.Runtime.append(gen_do_stmts_ctx(ctx_with_pat, (indent + 4), rest), Nova.Runtime.append("\n", Nova.Runtime.append(ind_str, "end")))))))))))))
else
  if (monad_type == 1) do
    Nova.Runtime.append(ind_str, Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr_prime(ctx, 0, e), Nova.Runtime.append(" do\n", Nova.Runtime.append(ind_str, Nova.Runtime.append("  {:left, err} -> {:left, err}\n", Nova.Runtime.append(ind_str, Nova.Runtime.append("  {:right, ", Nova.Runtime.append(pat_str, Nova.Runtime.append("} ->\n", Nova.Runtime.append(gen_do_stmts_ctx(ctx_with_pat, (indent + 4), rest), Nova.Runtime.append("\n", Nova.Runtime.append(ind_str, "end")))))))))))))
  else
    Nova.Runtime.append(ind_str, Nova.Runtime.append("bind(", Nova.Runtime.append(gen_expr_prime(ctx, 0, e), Nova.Runtime.append(", fn ", Nova.Runtime.append(pat_str, Nova.Runtime.append(" ->\n", Nova.Runtime.append(gen_do_stmts_ctx(ctx_with_pat, (indent + 2), rest), Nova.Runtime.append("\n", Nova.Runtime.append(ind_str, "end)")))))))))
  end
end
        end
    end
  ...
  def detect_monad_type(expr) do
      ...
      is_either_func = fn name -> (Nova.String.contains(Nova.String.pattern("parse"), Nova.String.to_lower(name)) or (Nova.String.contains(Nova.String.pattern("unify"), Nova.String.to_lower(name)) or (Nova.String.contains(Nova.String.pattern("expect"), Nova.String.to_lower(name)) or (Nova.String.contains(Nova.String.pattern("collect"), Nova.String.to_lower(name)) or (Nova.String.contains(Nova.String.pattern("infer"), Nova.String.to_lower(name)) or (Nova.String.contains(Nova.String.pattern("check"), Nova.String.to_lower(name)) or (Nova.String.contains(Nova.String.pattern("instantiate"), Nova.String.to_lower(name)) or (Nova.String.contains(Nova.String.pattern("generalize"), Nova.String.to_lower(name)) or (Nova.String.contains(Nova.String.pattern("lookup"), Nova.String.to_lower(name)) or ((name == "success") or (name == "failure"))))))))))) end
  ...
  def gen_data_type(dt) do
      ...
      gen_tuple_constructor = fn con -> 
        arity = Nova.Runtime.length(con.fields)
        params = Nova.Array.map_with_index(fn i -> fn _ -> Nova.Runtime.append("arg", Nova.Runtime.show(i)) end end, con.fields)
        args = Nova.Runtime.intercalate(", ", params)
        body = if (arity == 0) do
          Nova.Runtime.append(":", snake_case(con.name))
        else
          Nova.Runtime.append("{:", Nova.Runtime.append(snake_case(con.name), Nova.Runtime.append(", ", Nova.Runtime.append(args, "}"))))
        end
        Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(con.name), Nova.Runtime.append("(", Nova.Runtime.append(args, Nova.Runtime.append("), do: ", body))))) end
      gen_record_constructor = fn con -> 
        params = Nova.Runtime.map(fn f -> snake_case(f.label) end, con.fields)
        fields = Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn f -> Nova.Runtime.append(snake_case(f.label), Nova.Runtime.append(": ", snake_case(f.label))) end, con.fields))
        args = Nova.Runtime.intercalate(", ", params)
        Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(con.name), Nova.Runtime.append("(", Nova.Runtime.append(args, Nova.Runtime.append("), do: %{__type__: :", Nova.Runtime.append(snake_case(con.name), Nova.Runtime.append(", ", Nova.Runtime.append(fields, "}")))))))) end
      gen_constructor = fn con -> if con.is_record do
        gen_record_constructor.(con)
      else
        gen_tuple_constructor.(con)
      end end
      Nova.Runtime.append("  # Data type: ", Nova.Runtime.append(dt.name, Nova.Runtime.append("\n", Nova.Runtime.intercalate("\n", Nova.Runtime.map(gen_constructor, dt.constructors)))))
  end

  def gen_newtype(nt) do
    Nova.Runtime.append("  # Newtype: ", Nova.Runtime.append(nt.name, Nova.Runtime.append("\n", Nova.Runtime.append("  def ", Nova.Runtime.append(snake_case(nt.constructor), Nova.Runtime.append("(arg0), do: {:'", Nova.Runtime.append(snake_case(nt.constructor), "', arg0}")))))))
  end

  def gen_type_class(tc) do
    Nova.Runtime.append("  # Type class: ", Nova.Runtime.append(tc.name, Nova.Runtime.append(" ", Nova.Runtime.intercalate(" ", tc.type_vars))))
  end

  def gen_type_class_instance(inst) do
    if inst.derived do
      Nova.Runtime.append("  # derive instance ", Nova.Runtime.append(inst.class_name, Nova.Runtime.append(" ", gen_type_expr(inst.ty))))
    else
      Nova.Runtime.append("  # instance ", Nova.Runtime.append(inst.class_name, Nova.Runtime.append(" ", gen_type_expr(inst.ty))))
    end
  end
  ...
  def gen_infix(inf) do
      ...
      Nova.Runtime.append("  # ", Nova.Runtime.append(assoc_str, Nova.Runtime.append(" ", Nova.Runtime.append(Nova.Runtime.show(inf.precedence), Nova.Runtime.append(" ", Nova.Runtime.append(inf.function_name, Nova.Runtime.append(" as ", inf.operator)))))))
  end

  def gen_type_alias(ta) do
    Nova.Runtime.append("  # @type ", Nova.Runtime.append(snake_case(ta.name), Nova.Runtime.append(" :: ", gen_type_expr(ta.ty))))
  end
  ...
  def gen_type_expr(({:ty_expr_app, f, arg})) do
    Nova.Runtime.append(gen_type_expr(f), Nova.Runtime.append("(", Nova.Runtime.append(gen_type_expr(arg), ")")))
  end

  def gen_type_expr(({:ty_expr_arrow, a, b})) do
    Nova.Runtime.append("(", Nova.Runtime.append(gen_type_expr(a), Nova.Runtime.append(" -> ", Nova.Runtime.append(gen_type_expr(b), ")"))))
  end

  def gen_type_expr(({:ty_expr_record, fields, _})) do
    Nova.Runtime.append("%{", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn ({:tuple, l, t}) -> Nova.Runtime.append(snake_case(l), Nova.Runtime.append(": ", gen_type_expr(t))) end, fields)), "}"))
  end
  ...
  def gen_type_expr(({:ty_expr_tuple, ts})) do
    Nova.Runtime.append("{", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map((&gen_type_expr/1), ts)), "}"))
  end
  ...
  {:just, %{head: cp, tail: rest}} -> 
      ...
      go.(rest).(not(is_upper)).(Nova.Runtime.append(acc, Nova.Runtime.append(prefix, lower)))
end
      end end end end end)
