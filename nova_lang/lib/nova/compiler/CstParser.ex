...
defmodule Nova.Compiler.CstParser do
  ...
  # @type token_stream :: list()(cst._source_token())
  ...
  Prelude.pure(%{token: tok, name: Nova.Compiler.Cst.ident(name)})
end)
  end
  ...
  {:just, ({:tuple, (Prelude.map((&Nova.Compiler.Cst.module_name/1), mod_)), name})}
end
        _ -> :nothing
      end end
      Nova.Runtime.bind(expect_map(extract_qual_lower), fn {:tuple, tok, ({:tuple, mod_, name})} ->
  Prelude.pure(%{token: tok, module: mod_, name: Nova.Compiler.Cst.ident(name)})
end)
  end
  ...
  Prelude.pure(%{token: tok, name: Nova.Compiler.Cst.proper(name)})
end)
  end
  ...
  def tok_qualified_upper_name() do
      ...
      extract_qual_upper = fn auto_arg0 -> case auto_arg0 do
        ({:tok_upper_name, mod_, name}) -> {:just, ({:tuple, (Prelude.map((&Nova.Compiler.Cst.module_name/1), mod_)), name})}
        _ -> :nothing
      end end
      Nova.Runtime.bind(expect_map(extract_qual_upper), fn {:tuple, tok, ({:tuple, mod_, name})} ->
  Prelude.pure(%{token: tok, module: mod_, name: Nova.Compiler.Cst.proper(name)})
end)
  end
  ...
  def tok_operator() do
      ...
      extract_op = fn auto_arg0 -> case auto_arg0 do
        ({:tok_operator, mod_, op}) -> {:just, ({:tuple, (Prelude.map((&Nova.Compiler.Cst.module_name/1), mod_)), op})}
        _ -> :nothing
      end end
      Nova.Runtime.bind(expect_map(extract_op), fn {:tuple, tok, ({:tuple, mod_, op})} ->
  Prelude.pure(%{token: tok, module: mod_, name: Nova.Compiler.Cst.operator(op)})
end)
  end
  ...
  def optional(p) do
    Nova.Runtime.alt((Prelude.map((fn x -> {:just, x} end), p)), Prelude.pure(:nothing))
  end
  ...
  Nova.Runtime.bind(p, fn a ->
    Prelude.pure(({:tuple, s, a}))
  end)
end))), fn tail ->
      Prelude.pure(%{head: head, tail: tail})
    end)
  end)
  end
  ...
  def wrapped(open, p, close) do
    ...
    Nova.Runtime.bind(p, fn value ->
      Nova.Runtime.bind(close, fn c ->
        Prelude.pure(%{open: o, value: value, close: c})
      end)
    end)
  end)
  end
  ...
  Nova.Runtime.bind(layout_items(p), fn items ->
    Nova.Runtime.bind(Nova.Runtime.alt(tok_layout_end(), Prelude.pure(dummy_token)), fn _ ->
      Prelude.pure(items)
    end)
  end)
end)
    ...
    Nova.Runtime.bind(some(parse_type_var_binding()), fn vars ->
      Nova.Runtime.bind(tok_dot(), fn dot ->
        Nova.Runtime.bind(parse_type(), fn body ->
          Prelude.pure((Nova.Compiler.Cst.type_forall(forall_tok, vars, dot, body)))
        end)
      end)
    end)
  end) end)
  ...
  Nova.Runtime.bind(parse_type1(), fn t2 ->
    Prelude.pure(({:tuple, arr, t2}))
  end)
end))), fn rest ->
      case rest do
  {:just, ({:tuple, arr, t2})} -> Prelude.pure((Nova.Compiler.Cst.type_constrained(t, arr, t2)))
  :nothing -> Prelude.pure(t)
end
    end)
  end) end)
  end
  ...
  Nova.Runtime.bind(parse_type2(), fn t2 ->
    Prelude.pure(({:tuple, arr, t2}))
      ...
      case rest do
  {:just, ({:tuple, arr, t2})} -> Prelude.pure((Nova.Compiler.Cst.type_arrow(t, arr, t2)))
  :nothing -> Prelude.pure(t)
end
    end)
  end) end)
  ...
  Prelude.pure((Nova.Compiler.Cst.type_app(head, args)))
end
    end)
  end) end)
  end
  ...
  def parse_type_parens() do
    ...
    Prelude.pure((Nova.Compiler.Cst.type_parens(w)))
  end) end)
  end
  ...
  def parse_type_record() do
    ...
    Prelude.pure((Nova.Compiler.Cst.type_record(w)))
  end) end)
  end
  ...
  Nova.Runtime.bind(parse_type(), fn t ->
    Prelude.pure(({:tuple, pipe, t}))
  end)
end))), fn tail ->
      Prelude.pure(%{labels: labels, tail: tail})
    end)
  end) end)
  end
  ...
  def parse_row_label() do
    ...
    Nova.Runtime.bind(tok_double_colon(), fn sep ->
      Nova.Runtime.bind(parse_type(), fn ty ->
        Prelude.pure(%{label: label, separator: sep, value: ty})
      end)
    end)
  end) end)
  end
  ...
  Prelude.pure(%{token: tok, name: Nova.Compiler.Cst.label(name)})
end)
  end
  ...
  Nova.Runtime.bind(parse_type(), fn t ->
    Prelude.pure(({:tuple, dc, t}))
  end)
end))), fn ann ->
      case ann do
  {:just, ({:tuple, dc, t})} -> Prelude.pure((Nova.Compiler.Cst.expr_typed(e, dc, t)))
  :nothing -> Prelude.pure(e)
end
    end)
  end) end)
  end
  ...
  Nova.Runtime.bind(parse_expr5(), fn func_expr ->
    Nova.Runtime.bind(tok_tick(), fn tick2 ->
      Nova.Runtime.bind(parse_expr3(), fn e2 ->
        Prelude.pure(({:tuple, %{open: tick1, value: func_expr, close: tick2}, e2}))
      end)
    end)
  end)
end))), fn tick_result ->
  ...
  {:just, ({:tuple, wrapped, e2})} ->   Nova.Runtime.bind(parse_expr2_infix(([{:tuple, wrapped, e2} | []])), fn rest ->
    Prelude.pure((Nova.Compiler.Cst.expr_infix(e, rest)))
  end)
  :nothing -> Prelude.pure(e)
end
  end)
  ...
  def parse_expr3() do
     ...
     Nova.Runtime.bind(parse_expr3(), fn e ->
       Prelude.pure((Nova.Compiler.Cst.expr_negate(neg, e)))
     end)
   end)
  ...
  Prelude.pure((Nova.Compiler.Cst.expr_app(head, args)))
end
    end)
  end) end)
  end
  ...
  {:just, updates} -> Prelude.pure((Nova.Compiler.Cst.expr_record_update(e, updates)))
  ...
  Nova.Runtime.bind(parse_label(), fn first ->
    Nova.Runtime.bind(many((Nova.Runtime.seq(tok_dot(), parse_label()))), fn rest ->
      Prelude.pure(%{dot: dot, path: %{head: first, tail: Prelude.map((fn l -> {:tuple, dot, l} end), rest)}})
    end)
  end)
end))), fn access ->
    case access do
  ...
  Nova.Runtime.bind(parse_record_update_field(), fn field ->
    Prelude.pure(({:tuple, comma, field}))
  end)
end))), fn rest ->
        Nova.Runtime.bind(tok_right_brace(), fn close ->
          Prelude.pure(%{open: open, value: %{head: first, tail: rest}, close: close})
        end)
      end)
    end)
  end)
  ...
  def parse_record_update_field() do
    ...
    Nova.Runtime.bind(tok_equals(), fn eq ->
      Nova.Runtime.bind(parse_expr(), fn value ->
        Prelude.pure((Nova.Compiler.Cst.record_update_leaf(label, eq, value)))
      end)
    end)
  end)
  end
        ...
        Nova.Runtime.bind(parse_expr(), fn true_expr ->
          Nova.Runtime.bind(tok_keyword("else"), fn else_kw ->
            Nova.Runtime.bind(parse_expr(), fn false_expr ->
              Prelude.pure((Nova.Compiler.Cst.expr_if(%{keyword: kw, cond_: cond_expr, then_kw: then_kw, then_branch: true_expr, else_kw: else_kw, else_branch: false_expr})))
            end)
          end)
        end)
      end)
    ...
    Nova.Runtime.bind(layout_block(parse_let_binding()), fn bindings ->
      Nova.Runtime.bind(tok_keyword("in"), fn in_kw ->
        Nova.Runtime.bind(parse_expr(), fn body ->
          Prelude.pure((Nova.Compiler.Cst.expr_let(%{keyword: kw, bindings: bindings, in_: in_kw, body: body})))
        end)
      end)
    end)
  end) end)
  ...
  def parse_lambda() do
    ...
    Nova.Runtime.bind(some(parse_binder()), fn binders ->
      Nova.Runtime.bind(tok_right_arrow(), fn arr ->
        Nova.Runtime.bind(parse_expr(), fn body ->
          Prelude.pure((Nova.Compiler.Cst.expr_lambda(%{symbol: bs, binders: binders, arrow: arr, body: body})))
        end)
      end)
    end)
  end) end)
    ...
    Nova.Runtime.bind(separated(parse_expr(), tok_comma()), fn head ->
      Nova.Runtime.bind(tok_keyword("of"), fn of_kw ->
        Nova.Runtime.bind(layout_block(parse_case_branch()), fn branches ->
          Prelude.pure((Nova.Compiler.Cst.expr_case(%{keyword: kw, head: head, of: of_kw, branches: branches})))
        end)
      end)
    end)
  end) end)
  ...
  def parse_case_branch() do
    ...
    Nova.Runtime.bind(parse_guarded_arrow(), fn guarded ->
      Prelude.pure(({:tuple, pats, guarded}))
    end)
  end) end)
  end
  ...
  Nova.Runtime.bind(layout_block(parse_let_binding()), fn bindings ->
    Prelude.pure(({:tuple, wh, bindings}))
  end)
end))), fn where_clause ->
        Prelude.pure((Nova.Compiler.Cst.unconditional(arrow, %{expr: expr, bindings: where_clause})))
      end)
    end)
  end) end)
  end
  ...
  def parse_guarded_exprs_arrow() do
    ...
    Prelude.pure((Nova.Compiler.Cst.guarded(guards)))
  end) end)
  end
  ...
  Nova.Runtime.bind(layout_block(parse_let_binding()), fn bindings ->
    Prelude.pure(({:tuple, wh, bindings}))
            ...
            Prelude.pure(%{bar: bar, patterns: patterns, separator: sep, where: %{expr: expr, bindings: where_clause}})
          end)
        end)
      end)
    end)
  ...
  def parse_do() do
    ...
    Nova.Runtime.bind(layout_block(parse_do_statement()), fn stmts ->
      Prelude.pure((Nova.Compiler.Cst.expr_do(%{keyword: kw, statements: stmts})))
    end)
  end) end)
  end
  ...
  def parse_do_let() do
    Control.Lazy.defer(fn _ ->   Nova.Runtime.bind(tok_keyword("let"), fn kw ->
    Nova.Runtime.bind(layout_block(parse_let_binding()), fn bindings ->
      Prelude.pure((Nova.Compiler.Cst.do_let(kw, bindings)))
    end)
  end) end)
  end
  ...
  def parse_do_bind() do
    ...
    Nova.Runtime.bind(tok_left_arrow(), fn arr ->
      Nova.Runtime.bind(parse_expr(), fn expr ->
        Prelude.pure((Nova.Compiler.Cst.do_bind(binder, arr, expr)))
      end)
    end)
  end) end)
  end
  ...
  def parse_let_sig() do
    ...
    Nova.Runtime.bind(tok_double_colon(), fn dc ->
      Nova.Runtime.bind(parse_type(), fn ty ->
        Prelude.pure((Nova.Compiler.Cst.let_binding_signature(%{label: name, separator: dc, value: ty})))
      end)
    end)
  end) end)
  end
  ...
  Nova.Runtime.bind(layout_block(parse_let_binding()), fn bindings ->
    Prelude.pure(({:tuple, wh, bindings}))
          ...
          Prelude.pure((Nova.Compiler.Cst.let_binding_pattern(pat, eq, %{expr: expr, bindings: where_clause})))
        end)
      end)
    end)
  end) end)
  ...
  def parse_let_name() do
    ...
    Nova.Runtime.bind(many(parse_binder_atom()), fn binders ->
      Nova.Runtime.bind(parse_guarded(), fn guarded ->
        Prelude.pure((Nova.Compiler.Cst.let_binding_name(%{name: name, binders: binders, guarded: guarded})))
      end)
    end)
  end) end)
  end
  ...
  Nova.Runtime.bind(layout_block(parse_let_binding()), fn bindings ->
    Prelude.pure(({:tuple, wh, bindings}))
        ...
        Prelude.pure((Nova.Compiler.Cst.unconditional(eq, %{expr: expr, bindings: where_clause})))
      end)
    end)
  end) end)
  end
  ...
  Nova.Runtime.bind(tok_left_arrow(), fn arr ->
    Prelude.pure(({:tuple, b, arr}))
  end)
end))), fn pat_bind ->
    Nova.Runtime.bind(parse_expr(), fn expr ->
      Prelude.pure(%{binder: pat_bind, expr: expr})
    end)
  end) end)
  end
  ...
  def parse_expr_section() do
    ...
    Prelude.pure((Nova.Compiler.Cst.expr_section(tok)))
  end)
  end
  ...
  def parse_expr_hole() do
    ...
    Prelude.pure((Nova.Compiler.Cst.expr_hole(name)))
  end)
  end
  ...
  def parse_expr_string() do
    ...
    Prelude.pure((Nova.Compiler.Cst.expr_string(tok, s)))
  end)
  end
  ...
  def parse_expr_int() do
    ...
    Prelude.pure((Nova.Compiler.Cst.expr_int(tok, n)))
  end)
  end
  ...
  def parse_expr_number() do
    ...
    Prelude.pure((Nova.Compiler.Cst.expr_number(tok, n)))
  end)
  end
  ...
  def parse_expr_char() do
    ...
    Prelude.pure((Nova.Compiler.Cst.expr_char(tok, c)))
  end)
  end
  ...
  def parse_expr_bool() do
     ...
     Prelude.pure((Nova.Compiler.Cst.expr_boolean(tok, true)))
   end)
      parse_false =    Nova.Runtime.bind(tok_keyword("false"), fn tok ->
     Prelude.pure((Nova.Compiler.Cst.expr_boolean(tok, false)))
   end)
  ...
  def parse_expr_array() do
    ...
    Prelude.pure((Nova.Compiler.Cst.expr_array(d)))
  end) end)
  end
  ...
  def parse_expr_record() do
    ...
    Prelude.pure((Nova.Compiler.Cst.expr_record(d)))
  end) end)
  end
  ...
  def parse_record_field_full() do
    ...
    Nova.Runtime.bind(Nova.Runtime.alt(tok_colon(), tok_equals()), fn sep ->
      Nova.Runtime.bind(parse_expr(), fn value ->
        Prelude.pure((Nova.Compiler.Cst.record_field(label, sep, value)))
      end)
    end)
  end) end)
  end
  ...
  def parse_expr_parens() do
     ...
     Nova.Runtime.bind(tok_operator(), fn op ->
       Nova.Runtime.bind(tok_right_paren(), fn _ ->
         Prelude.pure((Nova.Compiler.Cst.expr_op_name(op)))
       end)
     end)
   end)
     ...
     Prelude.pure((Nova.Compiler.Cst.expr_parens(w)))
   end) end)
  ...
  Nova.Runtime.bind(parse_binder2(), fn b2 ->
    Prelude.pure(({:tuple, op, b2}))
  end)
end))), fn ops ->
      if Nova.List.null(ops) do
  Prelude.pure(b)
else
  Prelude.pure((Nova.Compiler.Cst.binder_op(b, ops)))
end
    end)
  end) end)
  end
  ...
  Nova.Runtime.bind(parse_type(), fn t ->
    Prelude.pure(({:tuple, dc, t}))
      ...
      case ann do
  {:just, ({:tuple, dc, t})} -> Prelude.pure((Nova.Compiler.Cst.binder_typed(b, dc, t)))
  :nothing -> Prelude.pure(b)
end
    end)
  end) end)
  end
  ...
  def parse_binder_con() do
    ...
    Nova.Runtime.bind(some(parse_binder_atom()), fn args ->
      Prelude.pure((Nova.Compiler.Cst.binder_constructor(con, args)))
    end)
  end) end)
  end
  ...
  def parse_binder_nullary_con() do
    ...
    Prelude.pure((Nova.Compiler.Cst.binder_constructor(con, [])))
  end)
  end
  ...
  def parse_binder_wildcard() do
      Nova.Runtime.bind(token(Nova.Compiler.Cst.tok_underscore()), fn tok ->
    Prelude.pure((Nova.Compiler.Cst.binder_wildcard(tok)))
  end)
  end
  ...
  def parse_binder_hole() do
      Nova.Runtime.bind(tok_hole(), fn {:tuple, tok, hole_name} ->
        full_name = Nova.Runtime.append("_", hole_name)
        name = %{token: tok, name: Nova.Compiler.Cst.ident(full_name)}
    Prelude.pure((Nova.Compiler.Cst.binder_var(name)))
  end)
  end
  ...
  Nova.Runtime.bind(parse_binder_atom(), fn b ->
    Prelude.pure(({:tuple, at, b}))
  end)
end))), fn named ->
      case named do
  {:just, ({:tuple, at, b})} -> Prelude.pure((Nova.Compiler.Cst.binder_named(name, at, b)))
  :nothing -> Prelude.pure((Nova.Compiler.Cst.binder_var(name)))
end
    end)
  end) end)
  end
  ...
  def parse_binder_string() do
      Nova.Runtime.bind(tok_string(), fn {:tuple, tok, s} ->
    Prelude.pure((Nova.Compiler.Cst.binder_string(tok, s)))
  end)
  end
  ...
  Nova.Runtime.bind(tok_int(), fn {:tuple, tok, n} ->
    Prelude.pure((Nova.Compiler.Cst.binder_int(neg, tok, n)))
  end)
end)
  end
  ...
  def parse_binder_number() do
      ...
      Nova.Runtime.bind(optional((satisfy(is_neg))), fn neg ->
  Nova.Runtime.bind(tok_number(), fn {:tuple, tok, n} ->
    Prelude.pure((Nova.Compiler.Cst.binder_number(neg, tok, n)))
  end)
end)
  end
  ...
  def parse_binder_char() do
      Nova.Runtime.bind(tok_char(), fn {:tuple, tok, c} ->
    Prelude.pure((Nova.Compiler.Cst.binder_char(tok, c)))
  end)
  end
  ...
  def parse_binder_bool() do
     ...
     Prelude.pure((Nova.Compiler.Cst.binder_boolean(tok, true)))
   end)
      parse_binder_false =    Nova.Runtime.bind(tok_keyword("false"), fn tok ->
     Prelude.pure((Nova.Compiler.Cst.binder_boolean(tok, false)))
   end)
  ...
  def parse_binder_array() do
    ...
    Prelude.pure((Nova.Compiler.Cst.binder_array(d)))
  end) end)
  end
  ...
  def parse_binder_record() do
    ...
    Prelude.pure((Nova.Compiler.Cst.binder_record(d)))
  end) end)
  end
  ...
  def parse_binder_parens() do
    ...
    Prelude.pure((Nova.Compiler.Cst.binder_parens(w)))
  end) end)
  end
            ...
            Nova.Runtime.bind(parse_module_imports(), fn imports ->
              Nova.Runtime.bind(parse_module_decls(), fn decls ->
                Nova.Runtime.bind(optional(tok_layout_end()), fn _ ->
                  ...
                  Prelude.pure(%{header: header, body: body})
                end)
              end)
            end)
          end)
  ...
  :nothing -> Prelude.pure((Nova.Runtime.append(acc, ([imp | []]))))
end
  end)
end)), Prelude.pure(acc))  end end)
      go.([])
  end
  ...
  :nothing -> Prelude.pure((Nova.Runtime.append(acc, ([decl | []]))))
end
  end)
end)), Prelude.pure(acc))  end end)
  ...
  def parse_module_header() do
    ...
    Nova.Runtime.bind(parse_module_name(), fn name ->
      Nova.Runtime.bind(optional(parse_exports()), fn exports ->
        Nova.Runtime.bind(tok_keyword("where"), fn where_kw ->
          Prelude.pure(%{keyword: kw, name: name, exports: exports, where: where_kw, imports: []})
        end)
      end)
    end)
  end)
  ...
  Prelude.pure(%{token: tok, name: name})
end)
  end
  ...
  def parse_exports() do
    ...
    Nova.Runtime.bind(separated(parse_export(), tok_comma()), fn exports ->
      Nova.Runtime.bind(tok_right_paren(), fn close ->
        Prelude.pure(%{open: open, value: exports, close: close})
      end)
    end)
  end)
  end
  ...
  def parse_export_type() do
    ...
    Nova.Runtime.bind(optional(parse_data_members()), fn members ->
      Prelude.pure((Nova.Compiler.Cst.export_type(name, members)))
    end)
  end)
  end
  ...
  def parse_export_module() do
      Nova.Runtime.bind(tok_keyword("module"), fn kw ->
    Nova.Runtime.bind(parse_module_name(), fn name ->
      Prelude.pure((Nova.Compiler.Cst.export_module(kw, name)))
    end)
  end)
  end
  ...
  def parse_data_all() do
    ...
    Nova.Runtime.bind(tok_double_dot(), fn dotdot ->
      Nova.Runtime.bind(tok_right_paren(), fn _ ->
        Prelude.pure((Nova.Compiler.Cst.data_all(dotdot)))
      end)
    end)
  end)
  end
  ...
  def parse_data_enumerated() do
    ...
    Prelude.pure((Nova.Compiler.Cst.data_enumerated(d)))
  end)
  end
  ...
  Nova.Runtime.bind(wrapped(tok_left_paren(), (separated(parse_import_item(), tok_comma())), tok_right_paren()), fn imports ->
    Prelude.pure(({:tuple, is_hiding, imports}))
  end)
end))), fn names ->
        Nova.Runtime.bind(optional((Nova.Runtime.bind(tok_keyword("as"), fn as_kw ->
  Nova.Runtime.bind(parse_module_name(), fn alias_ ->
    Prelude.pure(({:tuple, as_kw, alias_}))
  end)
end))), fn qualified ->
          Prelude.pure(%{keyword: kw, module: mod_, names: names, qualified: qualified})
        end)
      end)
    end)
  end)
  ...
  def parse_import_op() do
    ...
    Nova.Runtime.bind(parse_op_name(), fn op ->
      Nova.Runtime.bind(tok_right_paren(), fn _ ->
        Prelude.pure((Nova.Compiler.Cst.import_op(op)))
      end)
    end)
  end)
  end
  ...
  def parse_import_type() do
      Nova.Runtime.bind(tok_upper_name(), fn name ->
    Nova.Runtime.bind(optional(parse_data_members()), fn members ->
      Prelude.pure((Nova.Compiler.Cst.import_type(name, members)))
    end)
  end)
  end
  ...
  def parse_import_class() do
    ...
    Nova.Runtime.bind(tok_upper_name(), fn name ->
      Prelude.pure((Nova.Compiler.Cst.import_class(kw, name)))
    end)
  end)
  end
  ...
  def parse_module_body() do
    ...
    Prelude.pure(%{decls: decls, trailing_comments: [], end_: %{line: 0, column: 0}})
  end)
  end
  ...
  Nova.Runtime.bind(separated(parse_data_ctor(), tok_pipe()), fn cs ->
    Prelude.pure(({:tuple, eq, cs}))
  end)
end))), fn ctors ->
          Prelude.pure((Nova.Compiler.Cst.decl_data(%{keyword: kw, name: name, vars: vars}, ctors)))
        end)
      end)
    end)
  end)
  ...
  def parse_data_ctor() do
    ...
    Nova.Runtime.bind(many(parse_type_atom()), fn fields ->
      Prelude.pure(%{name: name, fields: fields})
    end)
  end)
  end
  ...
  def parse_decl_type() do
    ...
    Nova.Runtime.bind(tok_upper_name(), fn name ->
      Nova.Runtime.bind(many(parse_type_var_binding()), fn vars ->
        Nova.Runtime.bind(tok_equals(), fn eq ->
          Nova.Runtime.bind(parse_type(), fn ty ->
            Prelude.pure((Nova.Compiler.Cst.decl_type(%{keyword: kw, name: name, vars: vars}, eq, ty)))
          end)
        end)
      end)
    end)
        ...
        Nova.Runtime.bind(tok_equals(), fn eq ->
          Nova.Runtime.bind(tok_upper_name(), fn ctor_name ->
            Nova.Runtime.bind(parse_type_atom(), fn wrapped_ty ->
              Prelude.pure((Nova.Compiler.Cst.decl_newtype(%{keyword: kw, name: name, vars: vars}, eq, ctor_name, wrapped_ty)))
            end)
          end)
        end)
      end)
  ...
  Nova.Runtime.bind(layout_block(parse_class_member()), fn ms ->
    Prelude.pure(({:tuple, where_kw, ms}))
  end)
end))), fn methods ->
          Prelude.pure((Nova.Compiler.Cst.decl_class(%{keyword: kw, super_: :nothing, name: name, vars: vars, fundeps: :nothing}, methods)))
        end)
      end)
    end)
  end)
  ...
  def parse_class_member() do
    ...
    Nova.Runtime.bind(tok_double_colon(), fn dc ->
      Nova.Runtime.bind(parse_type(), fn ty ->
        Prelude.pure(%{label: name, separator: dc, value: ty})
      end)
    end)
  end)
  end
  ...
  Nova.Runtime.bind(layout_block(parse_instance_binding()), fn bindings ->
    Prelude.pure(({:tuple, where_kw, bindings}))
  end)
end))), fn body ->
            ...
            Prelude.pure((Nova.Compiler.Cst.decl_instance_chain(%{head: inst, tail: []})))
          end)
        end)
      end)
    end)
  ...
  def parse_instance_sig() do
    ...
    Nova.Runtime.bind(tok_double_colon(), fn dc ->
      Nova.Runtime.bind(parse_type(), fn ty ->
        Prelude.pure((Nova.Compiler.Cst.instance_binding_signature(%{label: name, separator: dc, value: ty})))
      end)
    end)
  end)
  end
  ...
  def parse_instance_name() do
    ...
    Nova.Runtime.bind(many(parse_binder()), fn binders ->
      Nova.Runtime.bind(parse_guarded(), fn guarded ->
        Prelude.pure((Nova.Compiler.Cst.instance_binding_name(%{name: name, binders: binders, guarded: guarded})))
      end)
    end)
  end)
  end
    ...
    Prelude.pure(({:tuple, n, dc}))
          ...
          Nova.Runtime.bind(tok_qualified_upper_name(), fn class_name ->
            Nova.Runtime.bind(many(parse_type_atom()), fn types ->
              ...
              Prelude.pure((Nova.Compiler.Cst.decl_derive(derive_kw, newtype_kw, instance_head)))
            end)
          end)
        end)
      end)
  ...
  def parse_decl_foreign() do
    ...
    Nova.Runtime.bind(tok_keyword("import"), fn import_ ->
      Nova.Runtime.bind(parse_foreign_value(), fn foreign_prime ->
        Prelude.pure((Nova.Compiler.Cst.decl_foreign(foreign_, import_, foreign_prime)))
      end)
    end)
  end)
  end
  ...
  def parse_foreign_value() do
    ...
    Nova.Runtime.bind(tok_double_colon(), fn dc ->
      Nova.Runtime.bind(parse_type(), fn ty ->
        Prelude.pure((Nova.Compiler.Cst.foreign_value(%{label: name, separator: dc, value: ty})))
      end)
    end)
  end)
  end
  ...
  Nova.Runtime.bind(tok_int(), fn {:tuple, prec_tok, prec} ->
    Nova.Runtime.bind(parse_fixity_op(), fn op ->
      Prelude.pure((Nova.Compiler.Cst.decl_fixity(%{keyword: {:tuple, kw, fixity}, prec: {:tuple, prec_tok, (int_value_to_int.(prec))}, operator: op})))
    end)
  end)
end)
  end
  ...
  def parse_fixity_keyword() do
     ...
     Prelude.pure(({:tuple, tok, Nova.Compiler.Cst.infix()}))
   end)
      parse_infixl =    Nova.Runtime.bind(tok_keyword("infixl"), fn tok ->
     Prelude.pure(({:tuple, tok, Nova.Compiler.Cst.infixl()}))
   end)
      parse_infixr =    Nova.Runtime.bind(tok_keyword("infixr"), fn tok ->
     Prelude.pure(({:tuple, tok, Nova.Compiler.Cst.infixr()}))
   end)
  ...
  Nova.Runtime.bind(tok_keyword("as"), fn as_kw ->
    Nova.Runtime.bind(parse_op_name(), fn op ->
      Prelude.pure((Nova.Compiler.Cst.fixity_value((to_either_name.(name)), as_kw, op)))
    end)
  end)
end)
  end
  ...
  def parse_op_name() do
      Nova.Runtime.bind(tok_operator(), fn op ->
    Prelude.pure(%{token: op.token, name: op.name})
  end)
  end
  ...
  def parse_decl_signature() do
    ...
    Nova.Runtime.bind(tok_double_colon(), fn dc ->
      Nova.Runtime.bind(parse_type(), fn ty ->
        Prelude.pure((Nova.Compiler.Cst.decl_signature(%{label: name, separator: dc, value: ty})))
      end)
    end)
  end)
  end
  ...
  def parse_decl_value() do
    ...
    Nova.Runtime.bind(many(parse_binder_atom()), fn binders ->
      Nova.Runtime.bind(parse_guarded(), fn guarded ->
        Prelude.pure((Nova.Compiler.Cst.decl_value(%{name: name, binders: binders, guarded: guarded})))
      end)
    end)
  end)
  end
