defmodule Nova.Compiler.CodeGenCoreErlang do
  ...
  {:expr_let, binds, body} -> 
      bind_names = Nova.Set.from_foldable(Nova.Array.map_maybe(fn b -> get_pattern_var_name(b.pattern) end, binds))
  ...
  def gen_module(m) do
      ...
      get_imports = fn auto_arg0 -> case auto_arg0 do
        ({:decl_import, imp}) -> import_items_to_tuples(imp.module_name, imp.items)
        _ -> []
      end end
  ...
  all_funcs = Nova.Array.map_maybe(get_func, m.declarations)
  all_imports = Nova.Array.concat_map(get_imports, m.declarations)
  ...
  exports = Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn f -> Nova.Runtime.append(atom(f.name), Nova.Runtime.append("/", Nova.Runtime.show(f.arity))) end, unique_funcs))
  ...
  dt_comments = Nova.Runtime.intercalate("\n\n", Nova.Array.map_maybe(gen_decl_non_func.(ctx), m.declarations))
  Nova.Runtime.append("module ", Nova.Runtime.append(atom(mod_name), Nova.Runtime.append(" [", Nova.Runtime.append(exports, Nova.Runtime.append("]\n", Nova.Runtime.append("  attributes []\n", Nova.Runtime.append(dt_comments, Nova.Runtime.append(if (dt_comments == "") do
  ""
else
  "\n\n"
end, Nova.Runtime.append(func_defs, "\nend\n")))))))))
  end
  ...
  def has_complex_pattern(pats) do
      ...
      Nova.Array.any(is_complex, pats)
  end
  ...
  def gen_merged_function(ctx, group) do
      ...
      Nova.Runtime.append(atom(group.name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(arity), Nova.Runtime.append(" =\n", Nova.Runtime.append("  fun (", Nova.Runtime.append(params_str, Nova.Runtime.append(") ->\n", Nova.Runtime.append("    case {", Nova.Runtime.append(params_str, Nova.Runtime.append("} of\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n", case_clauses), Nova.Runtime.append("\n", "    end"))))))))))))
  end

  def gen_function_clause_as_case(ctx, _param_names, func) do
    
      pats_result = gen_pats_with_counter(func.parameters, 0)
      ...
      body = if Nova.Array.null(func.guards) do
        gen_expr(ctx_with_params, func.body)
      else
        gen_guarded_exprs(ctx_with_params, func.guards)
      end
      Nova.Runtime.append("      <", Nova.Runtime.append(pat_tuple, Nova.Runtime.append("> when 'true' ->\n        ", body)))
  end
  ...
  def gen_function(ctx, func) do
      ...
      params = Nova.Runtime.map((&gen_pattern/1), func.parameters)
      arity = Nova.Runtime.length(func.parameters)
      ctx_with_params = Nova.Runtime.foldr((&add_locals_from_pattern/2), ctx, func.parameters)
      ...
      Nova.Runtime.append(atom(func.name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(arity), Nova.Runtime.append(" =\n", Nova.Runtime.append("  fun (", Nova.Runtime.append(params_str, Nova.Runtime.append(") ->\n", Nova.Runtime.append("    ", body))))))))
  end
  ...
  def gen_one_guarded_expr(ctx, guarded_expr, rest) do
    case Nova.Array.uncons(guarded_expr.guards) do
      :nothing -> gen_expr(ctx, guarded_expr.body)
      {:just, %{head: clause, tail: more_clauses}} -> case clause do
          {:guard_expr, expr} -> 
              fallback = if (Nova.Array.null(rest) and Nova.Array.null(more_clauses)) do
                atom("error_no_matching_guard")
              else
                if Nova.Array.null(more_clauses) do
                  gen_guarded_exprs(ctx, rest)
                else
                  gen_one_guarded_expr(ctx, %{guards: more_clauses, body: guarded_expr.body}, rest)
                end
              end
              Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr(ctx, expr), Nova.Runtime.append(" of\n", Nova.Runtime.append("        <'true'> when 'true' -> ", Nova.Runtime.append(gen_expr(ctx, guarded_expr.body), Nova.Runtime.append("\n", Nova.Runtime.append("        <_> when 'true' -> ", Nova.Runtime.append(fallback, Nova.Runtime.append("\n", "      end")))))))))
          {:guard_pat, pat, bind_expr} -> 
              ...
              inner_body = if Nova.Array.null(more_clauses) do
              ...
              Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr(ctx, bind_expr), Nova.Runtime.append(" of\n", Nova.Runtime.append("        <", Nova.Runtime.append(gen_pattern(pat), Nova.Runtime.append("> when 'true' -> ", Nova.Runtime.append(inner_body, Nova.Runtime.append("\n", Nova.Runtime.append("        <_> when 'true' -> ", Nova.Runtime.append(fallback, Nova.Runtime.append("\n", "      end")))))))))))
        end
    end
  end

  def gen_data_type(_, dt) do
    Nova.Runtime.append("% Data type: ", Nova.Runtime.append(dt.name, Nova.Runtime.append("\n", Nova.Runtime.append("% Constructors: ", Nova.Runtime.intercalate(", ", Nova.Runtime.map(& &1.name, dt.constructors))))))
  end
  ...
  %{str: atom(to_snake_case(base_name)), counter: n}
    ...
    result = gen_pats_with_counter(pats, n)
    %{str: Nova.Runtime.append("{", Nova.Runtime.append(atom(to_snake_case(base_name)), Nova.Runtime.append(", ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", result.strs), "}")))), counter: result.counter}
end
  end
  ...
  def gen_pattern_with_counter(({:pat_record, fields}), n) do
      ...
      gen_field_pat = fn acc -> fn ({:tuple, label, pat}) -> 
        ...
        %{strs: Nova.Runtime.append(acc.strs, [Nova.Runtime.append(atom(to_snake_case(label)), Nova.Runtime.append(":=", r.str))]), counter: r.counter} end end
  ...
  def gen_pattern_with_counter(({:pat_cons, hd, tl}), n) do
      ...
      %{str: Nova.Runtime.append("[", Nova.Runtime.append(r1.str, Nova.Runtime.append(" | ", Nova.Runtime.append(r2.str, "]")))), counter: r2.counter}
  end

  def gen_pattern_with_counter(({:pat_as, name, pat}), n) do
    
      r = gen_pattern_with_counter(pat, n)
      %{str: Nova.Runtime.append(core_var(name), Nova.Runtime.append(" = ", r.str)), counter: r.counter}
  end
  ...
  case Nova.String.index_of(Nova.String.pattern("."), name) do
    {:just, idx} -> 
        ...
        Nova.Runtime.append("fun (_Qv0, _Qv1) -> call ", Nova.Runtime.append(atom(mod_name), Nova.Runtime.append(":", Nova.Runtime.append(atom(func_name), "(_Qv0, _Qv1)"))))
    :nothing -> if Nova.Set.member(name, ctx.locals) do
        ...
        case get_prelude_func(name) do
          {:just, info} -> 
              ...
              params_str = Nova.Runtime.intercalate(", ", param_names)
              Nova.Runtime.append("fun (", Nova.Runtime.append(params_str, Nova.Runtime.append(") -> call ", Nova.Runtime.append(atom(info.mod_), Nova.Runtime.append(":", Nova.Runtime.append(atom(info.func), Nova.Runtime.append("(", Nova.Runtime.append(params_str, ")"))))))))
          :nothing -> if Nova.Set.member(name, ctx.module_funcs) do
              
                arity = lookup_arity(name, ctx)
                if (arity == 0) do
  Nova.Runtime.append("apply ", Nova.Runtime.append(atom(name), "/0()"))
else
  
    param_names = Nova.Runtime.map(fn i -> Nova.Runtime.append("_Mf", Nova.Runtime.show(i)) end, Nova.Array.range(0, (arity - 1)))
    params_str = Nova.Runtime.intercalate(", ", param_names)
    Nova.Runtime.append("fun (", Nova.Runtime.append(params_str, Nova.Runtime.append(") -> apply ", Nova.Runtime.append(atom(name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(arity), Nova.Runtime.append("(", Nova.Runtime.append(params_str, ")"))))))))
end
            else
              case Nova.Map.lookup(name, ctx.imports) do
                {:just, src_mod} -> 
                    mod_name = translate_module_name(src_mod)
                    Nova.Runtime.append("call ", Nova.Runtime.append(atom(mod_name), Nova.Runtime.append(":", Nova.Runtime.append(atom(name), "()"))))
  ...
  def gen_expr(_ctx, ({:expr_qualified, mod_name, func_name})) do
    Nova.Runtime.append("call ", Nova.Runtime.append(atom(translate_module_name(mod_name)), Nova.Runtime.append(":", Nova.Runtime.append(atom(func_name), "()"))))
  end
  ...
  {:expr_var, name} -> case Nova.String.index_of(Nova.String.pattern("."), name) do
      {:just, idx} -> 
          mod_name = translate_module_name(Nova.String.take(idx, name))
          func_name = Nova.String.drop((idx + 1), name)
          Nova.Runtime.append("call ", Nova.Runtime.append(atom(mod_name), Nova.Runtime.append(":", Nova.Runtime.append(atom(func_name), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")"))))))
      :nothing -> if (name == "pure") do
          Nova.Runtime.append("{", Nova.Runtime.append(atom("_right"), Nova.Runtime.append(", ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), "}"))))
        else
          case get_prelude_func(name) do
            {:just, info} -> Nova.Runtime.append("call ", Nova.Runtime.append(atom(info.mod_), Nova.Runtime.append(":", Nova.Runtime.append(atom(info.func), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")"))))))
            :nothing -> if Nova.Set.member(name, ctx.locals) do
                Nova.Runtime.append("apply ", Nova.Runtime.append(core_var(name), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")"))))
              else
  ...
  Nova.Runtime.append("let <_Fn0> = apply ", Nova.Runtime.append(atom(name), Nova.Runtime.append("/0()\n", Nova.Runtime.append("      in apply _Fn0(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")")))))
else
  if (num_args >= declared_arity) do
    Nova.Runtime.append("apply ", Nova.Runtime.append(atom(name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(declared_arity), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")"))))))
  else
      ...
      Nova.Runtime.append("fun (", Nova.Runtime.append(params_str, Nova.Runtime.append(") -> apply ", Nova.Runtime.append(atom(name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(declared_arity), Nova.Runtime.append("(", Nova.Runtime.append(all_args, ")"))))))))
  end
end
                else
                  case Nova.Map.lookup(name, ctx.imports) do
                    {:just, src_mod} -> 
                        mod_name = translate_module_name(src_mod)
                        Nova.Runtime.append("call ", Nova.Runtime.append(atom(mod_name), Nova.Runtime.append(":", Nova.Runtime.append(atom(name), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")"))))))
                    :nothing -> if is_constructor_name.(name) do
                        if (Nova.Runtime.length(args) == 0) do
                          atom(to_snake_case(name))
                        else
                          Nova.Runtime.append("{", Nova.Runtime.append(atom(to_snake_case(name)), Nova.Runtime.append(", ", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), "}"))))
                        end
                      else
                        Nova.Runtime.append("apply ", Nova.Runtime.append(core_var(name), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")"))))
                      end
  ...
  {:expr_qualified, mod_name, func_name} -> Nova.Runtime.append("call ", Nova.Runtime.append(atom(translate_module_name(mod_name)), Nova.Runtime.append(":", Nova.Runtime.append(atom(func_name), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")"))))))
  _ -> Nova.Runtime.append("apply ", Nova.Runtime.append(gen_expr(ctx, func), Nova.Runtime.append("(", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, args)), ")"))))
end
  end

  def gen_expr(ctx, ({:expr_lambda, pats, body})) do
    case Nova.Array.uncons(pats) do
      :nothing -> gen_expr(ctx, body)
      {:just, %{head: pat, tail: rest_pats}} -> if Nova.Array.null(rest_pats) do
          if has_complex_pattern_single(pat) do
              ...
              Nova.Runtime.append("fun (", Nova.Runtime.append(var, Nova.Runtime.append(") ->\n", Nova.Runtime.append("      case ", Nova.Runtime.append(var, Nova.Runtime.append(" of\n", Nova.Runtime.append("        <", Nova.Runtime.append(pat_result.str, Nova.Runtime.append("> when 'true' -> ", Nova.Runtime.append(body_code, Nova.Runtime.append("\n", "      end")))))))))))
          else
            
              pat_result = gen_pattern_with_counter(pat, 0)
              ctx_with_param = add_locals_from_pattern(pat, ctx)
              Nova.Runtime.append("fun (", Nova.Runtime.append(pat_result.str, Nova.Runtime.append(") ->\n      ", gen_expr(ctx_with_param, body))))
          end
        else
          if has_complex_pattern_single(pat) do
              ...
              Nova.Runtime.append("fun (", Nova.Runtime.append(var, Nova.Runtime.append(") ->\n", Nova.Runtime.append("      case ", Nova.Runtime.append(var, Nova.Runtime.append(" of\n", Nova.Runtime.append("        <", Nova.Runtime.append(pat_result.str, Nova.Runtime.append("> when 'true' -> ", Nova.Runtime.append(inner_lambda, Nova.Runtime.append("\n", "      end")))))))))))
          else
  ...
  def gen_expr(ctx, ({:expr_let, binds, body})) do
    gen_let_binds_with_body(ctx, binds, body)
  end

  def gen_expr(ctx, ({:expr_if, cond_, then_e, else_e})) do
    Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr(ctx, cond_), Nova.Runtime.append(" of\n", Nova.Runtime.append("      <", Nova.Runtime.append(atom("true"), Nova.Runtime.append("> when 'true' -> ", Nova.Runtime.append(gen_expr(ctx, then_e), Nova.Runtime.append("\n", Nova.Runtime.append("      <", Nova.Runtime.append(atom("false"), Nova.Runtime.append("> when 'true' -> ", Nova.Runtime.append(gen_expr(ctx, else_e), Nova.Runtime.append("\n", "    end")))))))))))))
  end

  def gen_expr(ctx, ({:expr_case, scrutinee, clauses})) do
    
      scrut_expr = gen_expr(ctx, scrutinee)
      Nova.Runtime.append("case ", Nova.Runtime.append(scrut_expr, Nova.Runtime.append(" of\n", Nova.Runtime.append(gen_case_clauses_with_fallback(ctx, scrut_expr, clauses), Nova.Runtime.append("\n", "    end")))))
  end

  def gen_expr(ctx, ({:expr_bin_op, ":", l, r})) do
    Nova.Runtime.append("[", Nova.Runtime.append(gen_expr(ctx, l), Nova.Runtime.append(" | ", Nova.Runtime.append(gen_expr(ctx, r), "]"))))
  end

  def gen_expr(ctx, ({:expr_bin_op, "<>", l, r})) do
    Nova.Runtime.append("call 'erlang':'++'(", Nova.Runtime.append(gen_expr(ctx, l), Nova.Runtime.append(", ", Nova.Runtime.append(gen_expr(ctx, r), ")"))))
  end
  ...
  def gen_expr(ctx, ({:expr_bin_op, op, l, r})) do
    case Nova.String.index_of(Nova.String.pattern("."), op) do
      {:just, idx} -> 
          ...
          Nova.Runtime.append("call ", Nova.Runtime.append(atom(mod_name), Nova.Runtime.append(":", Nova.Runtime.append(atom(func_name), Nova.Runtime.append("(", Nova.Runtime.append(gen_expr(ctx, l), Nova.Runtime.append(", ", Nova.Runtime.append(gen_expr(ctx, r), ")"))))))))
      :nothing -> case op do
          "&&" -> Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr(ctx, l), Nova.Runtime.append(" of <'true'> when 'true' -> ", Nova.Runtime.append(gen_expr(ctx, r), " <_> when 'true' -> 'false' end"))))
          "||" -> Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr(ctx, l), Nova.Runtime.append(" of <'true'> when 'true' -> 'true'", Nova.Runtime.append(" <_> when 'true' -> ", Nova.Runtime.append(gen_expr(ctx, r), " end")))))
          _ -> 
              erl_op = translate_op(op)
              Nova.Runtime.append("call 'erlang':'", Nova.Runtime.append(erl_op, Nova.Runtime.append("'(", Nova.Runtime.append(gen_expr(ctx, l), Nova.Runtime.append(", ", Nova.Runtime.append(gen_expr(ctx, r), ")"))))))
        end
    end
  end

  def gen_expr(ctx, ({:expr_unary_op, "-", e})) do
    Nova.Runtime.append("call 'erlang':'-'(", Nova.Runtime.append(gen_expr(ctx, e), ")"))
  end

  def gen_expr(ctx, ({:expr_unary_op, "!", e})) do
    Nova.Runtime.append("call 'erlang':'not'(", Nova.Runtime.append(gen_expr(ctx, e), ")"))
  end
  ...
  def gen_expr(ctx, ({:expr_tuple, elems})) do
    Nova.Runtime.append("{", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, elems)), "}"))
  end

  def gen_expr(ctx, ({:expr_record, fields})) do
    
      gen_field = fn ({:tuple, label, expr}) -> Nova.Runtime.append(atom(to_snake_case(label)), Nova.Runtime.append("=>", gen_expr(ctx, expr))) end
      Nova.Runtime.append("~{", Nova.Runtime.append(Nova.Runtime.intercalate(",", Nova.Runtime.map(gen_field, fields)), "}~"))
  end

  def gen_expr(ctx, ({:expr_record_access, expr, field})) do
    case expr do
      {:expr_var, "_"} -> Nova.Runtime.append("fun (_Ra) -> call 'maps':'get'(", Nova.Runtime.append(atom(to_snake_case(field)), ", _Ra)"))
      _ -> Nova.Runtime.append("call 'maps':'get'(", Nova.Runtime.append(atom(to_snake_case(field)), Nova.Runtime.append(", ", Nova.Runtime.append(gen_expr(ctx, expr), ")"))))
    end
  end

  def gen_expr(ctx, ({:expr_record_update, expr, fields})) do
    
      gen_field_update = fn ({:tuple, label, val}) -> Nova.Runtime.append(atom(to_snake_case(label)), Nova.Runtime.append("=>", gen_expr(ctx, val))) end
      
  updates = Nova.Runtime.intercalate(",", Nova.Runtime.map(gen_field_update, fields))
  Nova.Runtime.append("call 'maps':'merge'(", Nova.Runtime.append(gen_expr(ctx, expr), Nova.Runtime.append(", ~{", Nova.Runtime.append(updates, "}~)"))))
  end
  ...
  def gen_expr(_ctx, ({:expr_section, op})) do
    Nova.Runtime.append("fun (X, Y) -> call 'erlang':'", Nova.Runtime.append(translate_op(op), "'(X, Y)"))
  end

  def gen_expr(ctx, ({:expr_section_left, e, op})) do
    Nova.Runtime.append("fun (X) -> call 'erlang':'", Nova.Runtime.append(translate_op(op), Nova.Runtime.append("'(", Nova.Runtime.append(gen_expr(ctx, e), ", X)"))))
  end

  def gen_expr(ctx, ({:expr_section_right, op, e})) do
    Nova.Runtime.append("fun (X) -> call 'erlang':'", Nova.Runtime.append(translate_op(op), Nova.Runtime.append("'(X, ", Nova.Runtime.append(gen_expr(ctx, e), ")"))))
  end
  ...
  def gen_expr_letrec(ctx, expr) do
    case expr do
      {:expr_lambda, pats, body} -> if has_complex_pattern(pats) do
            ...
            arity = Nova.Runtime.length(pats)
            pat_result = gen_pats_with_counter(pats, 0)
            ...
            params_str = Nova.Runtime.intercalate(", ", param_names)
            Nova.Runtime.append("fun (", Nova.Runtime.append(params_str, Nova.Runtime.append(") ->\n", Nova.Runtime.append("      case {", Nova.Runtime.append(params_str, Nova.Runtime.append("} of\n", Nova.Runtime.append("        <", Nova.Runtime.append(pat_tuple, Nova.Runtime.append("> when 'true' -> ", Nova.Runtime.append(body_code, Nova.Runtime.append("\n", "      end")))))))))))
        else
          
            pat_result = gen_pats_with_counter(pats, 0)
            ctx_with_params = Nova.Runtime.foldr((&add_locals_from_pattern/2), ctx, pats)
            Nova.Runtime.append("fun (", Nova.Runtime.append(Nova.Runtime.intercalate(", ", pat_result.strs), Nova.Runtime.append(") ->\n      ", gen_expr(ctx_with_params, body))))
        end
      _ -> gen_expr(ctx, expr)
    end
  end
  ...
  def expr_contains_var(name, expr) do
    case expr do
      ...
      {:expr_let, binds, body} -> (Nova.Array.any(fn b -> expr_contains_var(name, b.value) end, binds) or expr_contains_var(name, body))
      {:expr_if, c, t, e} -> (expr_contains_var(name, c) or (expr_contains_var(name, t) or expr_contains_var(name, e)))
      {:expr_case, scrut, clauses} -> (expr_contains_var(name, scrut) or Nova.Array.any(fn cl -> expr_contains_var(name, cl.body) end, clauses))
      {:expr_do, stmts} -> Nova.Array.any(fn auto_p0 -> do_stmt_contains_var(name, auto_p0) end, stmts)
      {:expr_bin_op, _, l, r} -> (expr_contains_var(name, l) or expr_contains_var(name, r))
      {:expr_unary_op, _, e} -> expr_contains_var(name, e)
      {:expr_list, elems} -> Nova.Array.any(fn auto_p0 -> expr_contains_var(name, auto_p0) end, elems)
      {:expr_tuple, elems} -> Nova.Array.any(fn auto_p0 -> expr_contains_var(name, auto_p0) end, elems)
      {:expr_record, fields} -> Nova.Array.any(fn ({:tuple, _, e}) -> expr_contains_var(name, e) end, fields)
      {:expr_record_access, e, _} -> expr_contains_var(name, e)
      {:expr_record_update, e, updates} -> (expr_contains_var(name, e) or Nova.Array.any(fn ({:tuple, _, e_prime}) -> expr_contains_var(name, e_prime) end, updates))
  ...
  def do_stmt_contains_var(name, stmt) do
    case stmt do
      {:do_let, binds} -> Nova.Array.any(fn b -> expr_contains_var(name, b.value) end, binds)
  ...
  :nothing -> add_locals_from_pattern(bind.pattern, ctx_prime)
      ...
      gen_letrec_def = fn ctx_prime -> fn bind -> 
        ...
        Nova.Runtime.append(atom(bind_name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(arity), Nova.Runtime.append(" = ", val)))) end end
      gen_letrec_clause_as_case = Nova.Runtime.fix3(fn gen_letrec_clause_as_case -> fn ctx_prime -> fn _param_names -> fn bind -> case bind.value do
        {:expr_lambda, pats, body} -> 
            pats_result = gen_pats_with_counter(pats, 0)
            ctx_with_params = Nova.Runtime.foldr((&add_locals_from_pattern/2), ctx_prime, pats)
            pat_tuple = Nova.Runtime.append("{", Nova.Runtime.append(Nova.Runtime.intercalate(", ", pats_result.strs), "}"))
            body_str = gen_expr(ctx_with_params, body)
            Nova.Runtime.append("        <", Nova.Runtime.append(pat_tuple, Nova.Runtime.append("> when 'true' -> ", body_str)))
      ...
      gen_letrec_def_grouped = fn ctx_prime -> fn group -> case group.binds do
        ...
        multiple -> 
            ...
            Nova.Runtime.append(atom(group.name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(group.arity), Nova.Runtime.append(" = fun (", Nova.Runtime.append(params_str, Nova.Runtime.append(") ->\n", Nova.Runtime.append("      case {", Nova.Runtime.append(params_str, Nova.Runtime.append("} of\n", Nova.Runtime.append(Nova.Runtime.intercalate("\n", case_clauses), Nova.Runtime.append("\n", "      end")))))))))))
      end end end
  ...
  Nova.Runtime.append("let <", Nova.Runtime.append(pat, Nova.Runtime.append("> = ", Nova.Runtime.append(val, Nova.Runtime.append("\n      in ", continuation)))))
else
  Nova.Runtime.append("let <", Nova.Runtime.append(tmp_var, Nova.Runtime.append("> = ", Nova.Runtime.append(val, Nova.Runtime.append("\n      in case ", Nova.Runtime.append(tmp_var, Nova.Runtime.append(" of\n        <", Nova.Runtime.append(pat, Nova.Runtime.append("> when 'true' -> ", Nova.Runtime.append(continuation_complex, "\n      end"))))))))))
end
    end
  end
  ...
  def gen_let_binds(ctx, binds) do
      ...
      gen_bind = fn bind -> fn acc -> 
        ...
        if is_rec do
  %{fst: Nova.Runtime.append("letrec ", Nova.Runtime.append(atom(func_name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(arity), Nova.Runtime.append(" = ", Nova.Runtime.append(val, Nova.Runtime.append("\n      in ", acc.fst))))))), snd: new_ctx}
else
  %{fst: Nova.Runtime.append("let <", Nova.Runtime.append(pat, Nova.Runtime.append("> = ", Nova.Runtime.append(val, Nova.Runtime.append("\n      in ", acc.fst))))), snd: new_ctx}
end end end
  ...
  def gen_case_clauses_with_fallback(ctx, scrut_expr, clauses) do
    case Nova.Array.uncons(clauses) do
      ...
      {:just, %{head: clause, tail: rest}} -> if (is_wildcard_pattern(clause.pattern) and Nova.Runtime.is_just(clause.guard)) do
          gen_guarded_wildcard_clause(ctx, scrut_expr, clause, rest)
            ...
            fallback = if (Nova.Array.null(same_pattern) and (Nova.Array.null(different) or Nova.Runtime.is_nothing(clause.guard))) do
              :nothing
            else
              {:just, gen_fallback_for_same_pattern(ctx_with_vars, scrut_expr, same_pattern, different)}
            end
            Nova.Runtime.append(gen_case_clause(ctx, clause, fallback), if Nova.Array.null(different) do
  ""
else
  ...
  def split_same_pattern_clauses(pat, clauses) do
      ...
      same_pattern = Nova.Array.take_while(is_same_guarded, clauses)
      different = Nova.Array.drop(Nova.Array.length(same_pattern), clauses)
      %{same_pattern: same_pattern, different: different}
  end

  def gen_fallback_for_same_pattern(ctx, scrut_expr, same_pattern, different) do
    case Nova.Array.uncons(same_pattern) do
      ...
      {:just, %{head: clause, tail: rest}} -> 
          ...
          Nova.Runtime.append("case ", Nova.Runtime.append(guard_expr, Nova.Runtime.append(" of\n", Nova.Runtime.append("            <'true'> when 'true' -> ", Nova.Runtime.append(body, Nova.Runtime.append("\n", Nova.Runtime.append("            <_> when 'true' -> ", Nova.Runtime.append(fallback, Nova.Runtime.append("\n", "          end")))))))))
    end
  end
      ...
      {:just, %{head: clause, tail: rest}} -> if is_wildcard_pattern(clause.pattern) do
          case clause.guard do
            {:just, g} -> 
                ...
                Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr(ctx, g), Nova.Runtime.append(" of\n", Nova.Runtime.append("            <'true'> when 'true' -> ", Nova.Runtime.append(body, Nova.Runtime.append("\n", Nova.Runtime.append("            <_> when 'true' -> ", Nova.Runtime.append(fallback, Nova.Runtime.append("\n", "          end")))))))))
  ...
  def gen_guarded_wildcard_clause(ctx, scrut_expr, clause, rest) do
      ...
      Nova.Runtime.append("      <", Nova.Runtime.append(pat, Nova.Runtime.append("> when 'true' ->\n", Nova.Runtime.append("        case ", Nova.Runtime.append(guard_expr, Nova.Runtime.append(" of\n", Nova.Runtime.append("          <'true'> when 'true' -> ", Nova.Runtime.append(body, Nova.Runtime.append("\n", Nova.Runtime.append("          <_> when 'true' -> ", Nova.Runtime.append(fallback, Nova.Runtime.append("\n", "        end"))))))))))))
  end
      ...
      body = case clause.guard do
        ...
        {:just, g} -> 
            fallback_code = case fallback do
              {:just, fb} -> fb
              :nothing -> Nova.Runtime.append("primop 'match_fail'({'case_clause', ", Nova.Runtime.append(gen_expr(ctx_with_vars, g), "})"))
            end
            Nova.Runtime.append("case ", Nova.Runtime.append(gen_expr(ctx_with_vars, g), Nova.Runtime.append(" of\n", Nova.Runtime.append("          <'true'> when 'true' -> ", Nova.Runtime.append(gen_expr(ctx_with_vars, clause.body), Nova.Runtime.append("\n", Nova.Runtime.append("          <_> when 'true' -> ", Nova.Runtime.append(fallback_code, Nova.Runtime.append("\n", "        end")))))))))
      end
      Nova.Runtime.append("      <", Nova.Runtime.append(pat, Nova.Runtime.append("> when 'true' ->\n        ", body)))
  end
  ...
  def gen_do_stmts(ctx, stmts) do
    case Nova.Array.uncons(stmts) do
      ...
      {:just, %{head: {:do_expr, e}, tail: rest}} -> 
          %{var: var, ctx: ctx_prime} = fresh_var(ctx)
          Nova.Runtime.append("let <", Nova.Runtime.append(var, Nova.Runtime.append("> = ", Nova.Runtime.append(gen_expr(ctx, e), Nova.Runtime.append("\n      in ", gen_do_stmts(ctx_prime, rest))))))
      {:just, %{head: {:do_bind, pat, e}, tail: rest}} -> 
          ...
          Nova.Runtime.append("case ", Nova.Runtime.append(bind_expr, Nova.Runtime.append(" of\n", Nova.Runtime.append("      <'_nothing'> when 'true' ->\n        '_nothing'\n", Nova.Runtime.append("      <{'_left', _Err}> when 'true' ->\n        {'_left', _Err}\n", Nova.Runtime.append("      <{'_just', ", Nova.Runtime.append(pat_code, Nova.Runtime.append("}> when 'true' ->\n        ", Nova.Runtime.append(rest_code, Nova.Runtime.append("\n", Nova.Runtime.append("      <{'_right', ", Nova.Runtime.append(pat_code, Nova.Runtime.append("}> when 'true' ->\n        ", Nova.Runtime.append(rest_code, "\n      end"))))))))))))))
      {:just, %{head: {:do_let, binds}, tail: rest}} -> gen_do_let_with_body(ctx, binds, rest)
    end
  end
  ...
  def gen_do_let_with_body(ctx, binds, rest) do
    case Nova.Array.uncons(binds) do
      ...
      {:just, %{head: bind, tail: more_binds}} -> 
          ...
          if is_rec do
  Nova.Runtime.append("letrec ", Nova.Runtime.append(atom(func_name), Nova.Runtime.append("/", Nova.Runtime.append(Nova.Runtime.show(arity), Nova.Runtime.append(" = ", Nova.Runtime.append(val, Nova.Runtime.append("\n      in ", continuation)))))))
else
  if is_simple_pattern(bind.pattern) do
    Nova.Runtime.append("let <", Nova.Runtime.append(pat, Nova.Runtime.append("> = ", Nova.Runtime.append(val, Nova.Runtime.append("\n      in ", continuation)))))
  else
  ...
  def gen_core_list(ctx, elems) do
    if (Nova.Array.length(elems) <= 50) do
      Nova.Runtime.append("[", Nova.Runtime.append(Nova.Runtime.intercalate(", ", Nova.Runtime.map(fn auto_p0 -> gen_expr(ctx, auto_p0) end, elems)), "]"))
    else
      case Nova.Array.uncons(elems) do
        :nothing -> "[]"
        {:just, %{head: h, tail: []}} -> Nova.Runtime.append("[", Nova.Runtime.append(gen_expr(ctx, h), "]"))
        {:just, %{head: h, tail: t}} -> Nova.Runtime.append("[", Nova.Runtime.append(gen_expr(ctx, h), Nova.Runtime.append("|", Nova.Runtime.append(gen_core_list(ctx, t), "]"))))
      end
    end
  end
