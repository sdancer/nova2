...
defmodule Nova.Loader do
  @moduledoc """
  Load all Nova Core Erlang modules in dependency order.
  Used for self-hosting verification and interactive development.
  """
  ...
  @doc """
  Load all Core Erlang modules in dependency order.
