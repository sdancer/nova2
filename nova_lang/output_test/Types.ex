...
defmodule Nova.Compiler.Types do
  ...
  def empty_env() do
    %{bindings: builtin_prelude(), counter: 0, registry_layer: :nothing, namespace: :nothing, type_aliases: builtin_record_aliases()}
  end



  def builtin_record_aliases() do
    Nova.Map.from_foldable([{:tuple, "TypeAliasInfo", ({:ty_record, %{fields: Nova.Map.from_foldable([{:tuple, "params", (t_array(t_string()))}, {:tuple, "body", t_type_expr()}]), row: :nothing}})}, {:tuple, "TCon", ({:ty_record, %{fields: Nova.Map.from_foldable([{:tuple, "name", t_string()}, {:tuple, "args", (t_array(t_type()))}]), row: :nothing}})}, {:tuple, "TVar", ({:ty_record, %{fields: Nova.Map.from_foldable([{:tuple, "id", t_int()}, {:tuple, "name", t_string()}]), row: :nothing}})}])
  end
